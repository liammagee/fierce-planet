...
#          t = desert
    ...
    # Australia
    red_team = Team.new("red", team_size)
...
#    red_team.fertility_rate_mean = 2.3
    ...
    # Yemen
    blue_team = Team.new("blue", team_size)
...
#    blue_team.fertility_rate_mean = 5.0
    ...
    # Swaziland
    green_team = Team.new("green", team_size)
...
#    green_team.fertility_rate_mean = 3.45
    ...
    world.teams << red_team
    world.teams << blue_team
    world.teams << green_team
