        ...
        .dialog({
            ...
            buttons: {
                "Play": function() {
                    // Animation effect
                    $( this ).dialog( "close" );
                    var world = $('#world, #map_canvas, #baseCanvas, #resourceCanvas, #scrollingCanvas, #noticeCanvas, #agentCanvas');
                    var ww = world.width();
                    var wh = world.height();
                    world.css({'width': 0, 'height' : 0});
                    world.css('height', 0);
                    world.animate({'width': ww, 'height': wh}, 2000);
