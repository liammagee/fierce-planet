...
FiercePlanet.LEGAL_SYSTEM_RESOURCE_TYPE=new ResourceType("Legal System","legal","/images/resources/legal.png",20,30,100,15);FiercePlanet.DEMOCRACY_RESOURCE_TYPE=new ResourceType("Democracy","democracy","/images/resources/democracy.png",25,40,100,20);FiercePlanet.FESTIVAL_RESOURCE_TYPE=new ResourceType("Festival","festival","/images/resources/festival.png",30,50,100,25);var FiercePlanet=FiercePlanet||{},TBL=TBL||{};TBL.ECO_CATEGORY=new ResourceCategory("Economic","eco","44ABE0");TBL.ENV_CATEGORY=new ResourceCategory("Environmental","env","CBDB2A");TBL.SOC_CATEGORY=new ResourceCategory("Social","soc","DE1F2A");TBL.ECO_CATEGORY.setEvaluateOtherCategoryImpact(function(a){var a=a.getCode(),b=1;a=="eco"?b*=1.2:a=="env"?b*=1:a=="soc"&&(b*=0.8);return b});
TBL.ENV_CATEGORY.setEvaluateOtherCategoryImpact(function(a){var a=a.getCode(),b=1;a=="eco"?b*=0.25:a=="env"?b*=1.2:a=="soc"&&(b*=1);return b});TBL.SOC_CATEGORY.setEvaluateOtherCategoryImpact(function(a){var a=a.getCode(),b=1;a=="eco"?b*=0.5:a=="env"?b*=1.1:a=="soc"&&(b*=1.2);return b});TBL.ECO_CATEGORY.addType(FiercePlanet.FARM_RESOURCE_TYPE);TBL.ECO_CATEGORY.addType(FiercePlanet.SHOP_RESOURCE_TYPE);TBL.ECO_CATEGORY.addType(FiercePlanet.BANK_RESOURCE_TYPE);TBL.ECO_CATEGORY.addType(FiercePlanet.FACTORY_RESOURCE_TYPE);
TBL.ECO_CATEGORY.addType(FiercePlanet.STOCKMARKET_RESOURCE_TYPE);TBL.ENV_CATEGORY.addType(FiercePlanet.FRESH_WATER_RESOURCE_TYPE);TBL.ENV_CATEGORY.addType(FiercePlanet.WILDLIFE_PARK_RESOURCE_TYPE);TBL.ENV_CATEGORY.addType(FiercePlanet.CLEAN_AIR_RESOURCE_TYPE);TBL.ENV_CATEGORY.addType(FiercePlanet.GREEN_ENERGY_RESOURCE_TYPE);TBL.ENV_CATEGORY.addType(FiercePlanet.BIODIVERSITY_RESOURCE_TYPE);TBL.SOC_CATEGORY.addType(FiercePlanet.CLINIC_RESOURCE_TYPE);TBL.SOC_CATEGORY.addType(FiercePlanet.SCHOOL_RESOURCE_TYPE);
TBL.SOC_CATEGORY.addType(FiercePlanet.LEGAL_SYSTEM_RESOURCE_TYPE);TBL.SOC_CATEGORY.addType(FiercePlanet.DEMOCRACY_RESOURCE_TYPE);TBL.SOC_CATEGORY.addType(FiercePlanet.FESTIVAL_RESOURCE_TYPE);TBL.ECONOMIC_RESOURCE_TYPES=[FiercePlanet.FARM_RESOURCE_TYPE,FiercePlanet.SHOP_RESOURCE_TYPE,FiercePlanet.BANK_RESOURCE_TYPE,FiercePlanet.FACTORY_RESOURCE_TYPE,FiercePlanet.STOCKMARKET_RESOURCE_TYPE];
...
TBL.doSetup=function(){FiercePlanet.registerResourceCategories([TBL.ECO_CATEGORY,TBL.ENV_CATEGORY,TBL.SOC_CATEGORY]);FiercePlanet.registerResourceTypes(TBL.ECONOMIC_RESOURCE_TYPES.concat(TBL.ENVIRONMENTAL_RESOURCE_TYPES.concat(TBL.SOCIAL_RESOURCE_TYPES)))};var FiercePlanet=FiercePlanet||{},CoS=CoS||{};CoS.ECO_CATEGORY=new ResourceCategory("Economy","eco","44ABE0");CoS.ENV_CATEGORY=new ResourceCategory("Ecology","enl","CBDB2A");CoS.POL_CATEGORY=new ResourceCategory("Political","pol","DE1F2A");CoS.CUL_CATEGORY=new ResourceCategory("Cultural","cul","2ADBCB");CoS.ECO_CATEGORY.addType(FiercePlanet.FARM_RESOURCE_TYPE);CoS.ECO_CATEGORY.addType(FiercePlanet.SHOP_RESOURCE_TYPE);CoS.ECO_CATEGORY.addType(FiercePlanet.BANK_RESOURCE_TYPE);CoS.ECO_CATEGORY.addType(FiercePlanet.FACTORY_RESOURCE_TYPE);
CoS.ECO_CATEGORY.addType(FiercePlanet.STOCKMARKET_RESOURCE_TYPE);CoS.ENV_CATEGORY.addType(FiercePlanet.FRESH_WATER_RESOURCE_TYPE);CoS.ENV_CATEGORY.addType(FiercePlanet.WILDLIFE_PARK_RESOURCE_TYPE);CoS.ENV_CATEGORY.addType(FiercePlanet.CLEAN_AIR_RESOURCE_TYPE);CoS.ENV_CATEGORY.addType(FiercePlanet.GREEN_ENERGY_RESOURCE_TYPE);CoS.ENV_CATEGORY.addType(FiercePlanet.BIODIVERSITY_RESOURCE_TYPE);CoS.POL_CATEGORY.addType(FiercePlanet.LEGAL_SYSTEM_RESOURCE_TYPE);CoS.POL_CATEGORY.addType(FiercePlanet.DEMOCRACY_RESOURCE_TYPE);
CoS.CUL_CATEGORY.addType(FiercePlanet.CLINIC_RESOURCE_TYPE);CoS.CUL_CATEGORY.addType(FiercePlanet.SCHOOL_RESOURCE_TYPE);CoS.CUL_CATEGORY.addType(FiercePlanet.FESTIVAL_RESOURCE_TYPE);CoS.ECONOMIC_RESOURCE_TYPES=[FiercePlanet.FARM_RESOURCE_TYPE,FiercePlanet.SHOP_RESOURCE_TYPE,FiercePlanet.BANK_RESOURCE_TYPE,FiercePlanet.FACTORY_RESOURCE_TYPE,FiercePlanet.STOCKMARKET_RESOURCE_TYPE];
...
FiercePlanet.VISIONARY_CAPABILITIES=FiercePlanet.EXPERT_CAPABILITIES.concat(["factory","energy","democracy"]);FiercePlanet.GENIUS_CAPABILITIES=FiercePlanet.VISIONARY_CAPABILITIES.concat(["stockmarket","biodiversity","festival"]);FiercePlanet.currentProfile=new Profile;FiercePlanet.capabilities=["farm","water","clinic"];FiercePlanet.profileClass="Novice";FiercePlanet.credits=0;FiercePlanet.totalSaved=0;FiercePlanet.previousLevelScore=0;FiercePlanet.currentScore=0;FiercePlanet.resourcesInStore=0;
FiercePlanet.resourcesSpent=0;FiercePlanet.expiredAgentCount=0;FiercePlanet.savedAgentCount=0;FiercePlanet.savedAgentThisWaveCount=0;FiercePlanet.resourceStatsCount={};FiercePlanet.inDesignMode=!1;FiercePlanet.inPlay=!1;FiercePlanet.isMouseDown=!1;FiercePlanet.isMouseMoving=!1;FiercePlanet.scrollingImageVisible=!0;FiercePlanet.noticesVisible=!0;FiercePlanet.agentsCanCommunicate=!0;FiercePlanet.catastrophesVisible=!0;FiercePlanet.disableKeyboardShortcuts=!1;FiercePlanet.soundsPlayable=!1;
FiercePlanet.recording=!1;FiercePlanet.invisiblePath=!1;FiercePlanet.agentTracing=!1;FiercePlanet.resourcesUpgradeable=!1;FiercePlanet.resourcesInTension=!1;FiercePlanet.resourceBonus=!1;FiercePlanet.applyGeneralHealth=!1;FiercePlanet.ignoreResourceBalance=!1;FiercePlanet.godMode=!1;FiercePlanet.predatorsVisible=!1;FiercePlanet.rivalsVisible=!1;FiercePlanet.tilesMutable=!1;FiercePlanet.tilesRemovable=!1;FiercePlanet.backgroundIconsVisible=!1;FiercePlanet.resourceTypeNamespace=TBL;
FiercePlanet.resourceCategories=[];FiercePlanet.resourceTypes=[];FiercePlanet.agentTimerId=0;FiercePlanet.eventTarget=new EventTarget;FiercePlanet.recordedLevels=[];FiercePlanet.currentLevelNumber=1;FiercePlanet.currentWave=1;FiercePlanet.currentLevelPreset=!0;FiercePlanet.currentLevel=null;FiercePlanet.existingCurrentLevel=null;FiercePlanet.currentResourceId=null;FiercePlanet.currentResource=null;FiercePlanet.currentNotice=null;FiercePlanet.waveOverride=0;FiercePlanet.maxWaveMoves=0;
FiercePlanet.maxLevelMoves=0;FiercePlanet.levelOfDifficulty=FiercePlanet.MEDIUM_DIFFICULTY;FiercePlanet.resourceRecoveryCycle=5;FiercePlanet.interval=20;FiercePlanet.levelDelayCounter=0;FiercePlanet.waveDelayCounter=0;FiercePlanet.numAgents=1;FiercePlanet.waveCounter=0;FiercePlanet.levelCounter=0;FiercePlanet.gameCounter=0;FiercePlanet.globalRecordingCounter=0;FiercePlanet.zoomLevel=1;FiercePlanet.externalZoomLevel=1;FiercePlanet.panLeftOffset=0;FiercePlanet.panTopOffset=0;
FiercePlanet.worldWidth=14;FiercePlanet.worldHeight=11;FiercePlanet.cellWidth=FiercePlanet.WORLD_WIDTH/FiercePlanet.worldWidth;FiercePlanet.cellHeight=FiercePlanet.WORLD_HEIGHT/FiercePlanet.worldHeight;FiercePlanet.pieceWidth=FiercePlanet.cellWidth*0.5;FiercePlanet.pieceHeight=FiercePlanet.cellHeight*0.5;FiercePlanet.scrollingImage=new Image;FiercePlanet.scrollingImageX=0;FiercePlanet.scrollingImageOffset=1;FiercePlanet.audio=null;FiercePlanet.googleMap=null;FiercePlanet.currentX=null;
FiercePlanet.currentY=null;FiercePlanet.$gameOver=null;FiercePlanet.$completeLevel=null;FiercePlanet.$completeGame=null;FiercePlanet.$levelList=null;FiercePlanet.$upgradeDelete=null;FiercePlanet.$resourceGallery=null;FiercePlanet.$newLevel=null;FiercePlanet.$settingsDialog=null;FiercePlanet.$genericDialog=null;FiercePlanet.$designFeatures=null;FiercePlanet.$editProperties=null;FiercePlanet=FiercePlanet||{};FiercePlanet.loadSettingsFromStorage=function(){FiercePlanet.currentLevelNumber=localStorage.currentLevelNumber!=void 0?parseInt(localStorage.currentLevelNumber):FiercePlanet.currentLevelNumber;FiercePlanet.currentLevelPreset=localStorage.currentLevelPreset!=void 0?localStorage.currentLevelPreset==="true":FiercePlanet.currentLevelPreset;FiercePlanet.currentScore=localStorage.currentScore!=void 0?parseInt(localStorage.currentScore):FiercePlanet.currentScore};
