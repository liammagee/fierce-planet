...
Tile.prototype.setY=function(a){this._y=a};var FiercePlanet=FiercePlanet||{},TBL=TBL||{};TBL.ECO_CATEGORY=new ResourceCategory("Economic","eco","44ABE0");TBL.ENV_CATEGORY=new ResourceCategory("Environmental","env","CBDB2A");TBL.SOC_CATEGORY=new ResourceCategory("Social","soc","DE1F2A");TBL.ECO_CATEGORY.setEvaluateOtherCategoryImpact(function(a){var a=a.getCode(),b=1;a=="eco"?b*=1.2:a=="env"?b*=1:a=="soc"&&(b*=0.8);return b});
TBL.ENV_CATEGORY.setEvaluateOtherCategoryImpact(function(a){var a=a.getCode(),b=1;a=="eco"?b*=0.25:a=="env"?b*=1.2:a=="soc"&&(b*=1);return b});TBL.SOC_CATEGORY.setEvaluateOtherCategoryImpact(function(a){var a=a.getCode(),b=1;a=="eco"?b*=0.5:a=="env"?b*=1.1:a=="soc"&&(b*=1.2);return b});TBL.FARM_RESOURCE_TYPE=new ResourceType(TBL.ECO_CATEGORY,"Farm","farm","/images/resources/farm.png",10,20,100,20);
TBL.SHOP_RESOURCE_TYPE=new ResourceType(TBL.ECO_CATEGORY,"Shop","shop","/images/resources/shop.png",15,25,100,30);TBL.BANK_RESOURCE_TYPE=new ResourceType(TBL.ECO_CATEGORY,"Bank","bank","/images/resources/bank.png",20,30,100,50);TBL.FACTORY_RESOURCE_TYPE=new ResourceType(TBL.ECO_CATEGORY,"Factory","factory","/images/resources/factory.png",25,40,100,70);TBL.STOCKMARKET_RESOURCE_TYPE=new ResourceType(TBL.ECO_CATEGORY,"Stockmarket","stockmarket","/images/resources/stockmarket.png",30,50,100,90);
TBL.FRESH_WATER_RESOURCE_TYPE=new ResourceType(TBL.ENV_CATEGORY,"Fresh Water","water","/images/resources/water.png",10,20,100,10);TBL.WILDLIFE_PARK_RESOURCE_TYPE=new ResourceType(TBL.ENV_CATEGORY,"Wildlife Park","park","/images/resources/park.png",15,25,100,15);TBL.CLEAN_AIR_RESOURCE_TYPE=new ResourceType(TBL.ENV_CATEGORY,"Clear Air","air","/images/resources/air.png",20,30,100,25);
TBL.GREEN_ENERGY_RESOURCE_TYPE=new ResourceType(TBL.ENV_CATEGORY,"Green Energy","energy","/images/resources/energy.png",25,40,100,35);TBL.BIODIVERSITY_RESOURCE_TYPE=new ResourceType(TBL.ENV_CATEGORY,"Biodiversity","biodiversity","/images/resources/biodiversity.png",30,50,100,45);TBL.CLINIC_RESOURCE_TYPE=new ResourceType(TBL.SOC_CATEGORY,"Clinic","clinic","/images/resources/clinic.png",10,20,100,5);
TBL.SCHOOL_RESOURCE_TYPE=new ResourceType(TBL.SOC_CATEGORY,"School","school","/images/resources/school.png",15,25,100,8);TBL.LEGAL_SYSTEM_RESOURCE_TYPE=new ResourceType(TBL.SOC_CATEGORY,"Legal System","legal","/images/resources/legal.png",20,30,100,15);TBL.DEMOCRACY_RESOURCE_TYPE=new ResourceType(TBL.SOC_CATEGORY,"Democracy","democracy","/images/resources/democracy.png",25,40,100,20);
...
TBL.SOCIAL_RESOURCE_TYPES=[TBL.CLINIC_RESOURCE_TYPE,TBL.SCHOOL_RESOURCE_TYPE,TBL.LEGAL_SYSTEM_RESOURCE_TYPE,TBL.DEMOCRACY_RESOURCE_TYPE,TBL.FESTIVAL_RESOURCE_TYPE];TBL.doSetup=function(){FiercePlanet.registerResourceCategories([TBL.ECO_CATEGORY,TBL.ENV_CATEGORY,TBL.SOC_CATEGORY]);FiercePlanet.registerResourceTypes(TBL.ECONOMIC_RESOURCE_TYPES.concat(TBL.ENVIRONMENTAL_RESOURCE_TYPES.concat(TBL.SOCIAL_RESOURCE_TYPES)))};var FiercePlanet=FiercePlanet||{},CoS=CoS||{};CoS.ECO_CATEGORY=new ResourceCategory("Economy","eco","44ABE0");CoS.ENV_CATEGORY=new ResourceCategory("Ecology","enl","CBDB2A");CoS.POL_CATEGORY=new ResourceCategory("Political","pol","DE1F2A");CoS.CUL_CATEGORY=new ResourceCategory("Cultural","cul","2ADBCB");CoS.FARM_RESOURCE_TYPE=new ResourceType(CoS.ECO_CATEGORY,"Farm","farm","/images/resources/farm.png",10,20,100,20);
CoS.SHOP_RESOURCE_TYPE=new ResourceType(CoS.ECO_CATEGORY,"Shop","shop","/images/resources/shop.png",15,25,100,30);CoS.BANK_RESOURCE_TYPE=new ResourceType(CoS.ECO_CATEGORY,"Bank","bank","/images/resources/bank.png",20,30,100,50);CoS.FACTORY_RESOURCE_TYPE=new ResourceType(CoS.ECO_CATEGORY,"Factory","factory","/images/resources/factory.png",25,40,100,70);CoS.STOCKMARKET_RESOURCE_TYPE=new ResourceType(CoS.ECO_CATEGORY,"Stockmarket","stockmarket","/images/resources/stockmarket.png",30,50,100,90);
CoS.FRESH_WATER_RESOURCE_TYPE=new ResourceType(CoS.ENV_CATEGORY,"Fresh Water","water","/images/resources/water.png",10,20,100,10);CoS.WILDLIFE_PARK_RESOURCE_TYPE=new ResourceType(CoS.ENV_CATEGORY,"Wildlife Park","park","/images/resources/park.png",15,25,100,15);CoS.CLEAN_AIR_RESOURCE_TYPE=new ResourceType(CoS.ENV_CATEGORY,"Clear Air","air","/images/resources/air.png",20,30,100,25);
CoS.GREEN_ENERGY_RESOURCE_TYPE=new ResourceType(CoS.ENV_CATEGORY,"Green Energy","energy","/images/resources/energy.png",25,40,100,35);CoS.BIODIVERSITY_RESOURCE_TYPE=new ResourceType(CoS.ENV_CATEGORY,"Biodiversity","biodiversity","/images/resources/biodiversity.png",30,50,100,45);CoS.LEGAL_SYSTEM_RESOURCE_TYPE=new ResourceType(CoS.POL_CATEGORY,"Legal System","legal","/images/resources/legal.png",20,30,100,15);
CoS.DEMOCRACY_RESOURCE_TYPE=new ResourceType(CoS.POL_CATEGORY,"Democracy","democracy","/images/resources/democracy.png",25,40,100,20);CoS.CLINIC_RESOURCE_TYPE=new ResourceType(CoS.CUL_CATEGORY,"Clinic","clinic","/images/resources/clinic.png",10,20,100,5);CoS.SCHOOL_RESOURCE_TYPE=new ResourceType(CoS.CUL_CATEGORY,"School","school","/images/resources/school.png",15,25,100,8);
CoS.FESTIVAL_RESOURCE_TYPE=new ResourceType(CoS.CUL_CATEGORY,"Festival","festival","/images/resources/festival.png",30,50,100,25);CoS.ECONOMIC_RESOURCE_TYPES=[CoS.FARM_RESOURCE_TYPE,CoS.SHOP_RESOURCE_TYPE,CoS.BANK_RESOURCE_TYPE,CoS.FACTORY_RESOURCE_TYPE,CoS.STOCKMARKET_RESOURCE_TYPE];CoS.ECOLOGICAL_RESOURCE_TYPES=[CoS.FRESH_WATER_RESOURCE_TYPE,CoS.WILDLIFE_PARK_RESOURCE_TYPE,CoS.CLEAN_AIR_RESOURCE_TYPE,CoS.GREEN_ENERGY_RESOURCE_TYPE,CoS.BIODIVERSITY_RESOURCE_TYPE];
CoS.POLITICAL_RESOURCE_TYPES=[CoS.LEGAL_SYSTEM_RESOURCE_TYPE,CoS.DEMOCRACY_RESOURCE_TYPE];CoS.CULTURAL_RESOURCE_TYPES=[CoS.CLINIC_RESOURCE_TYPE,CoS.SCHOOL_RESOURCE_TYPE,CoS.FESTIVAL_RESOURCE_TYPE];
