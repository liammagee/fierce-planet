var INITIAL_HEALTH=100,MOVE_INCREMENTS=5;function AgentType(a,b){this._name=a;this._color=b;this._speed=MOVE_INCREMENTS;this._socialHealth=this._environmentalHealth=this._economicHealth=this._health=INITIAL_HEALTH;this._drawFunction=null}AgentType.prototype.getName=function(){return this._name};AgentType.prototype.getColor=function(){return this._color};AgentType.prototype.getHealth=function(){return this._health};AgentType.prototype.getEconomicHealth=function(){return this._economicHealth};
AgentType.prototype.getEnvironmentalHealth=function(){return this._environmentalHealth};AgentType.prototype.getSocialHealth=function(){return this._socialHealth};AgentType.prototype.getDrawFunction=function(){return this._drawFunction};AgentType.prototype.setDrawFunction=function(a){this._drawFunction=a};function Memory(a,b,c,d){this._agentID=a;this._mostRecentVisit=this._age=b;this._visits=1;this._x=c;this._y=d;this._distanceFromLastUntriedPath=-1}Memory.prototype.getAgentID=function(){return this._agentID};
...
Memory.prototype.getMostRecentVisit=function(){return this._mostRecentVisit};Memory.prototype.setMostRecentVisit=function(a){this._mostRecentVisit=a};Memory.prototype.getDistanceFromLastUntriedPath=function(){return this._distanceFromLastUntriedPath};Memory.prototype.setDistanceFromLastUntriedPath=function(a){this._distanceFromLastUntriedPath=a};MemoryOfAgent.prototype=new Memory;MemoryOfAgent.prototype.constructor=MemoryOfAgent;
...
Agent.prototype.setDelay=function(a){this._delay=a};Agent.prototype.getHealth=function(){return this._health};Agent.prototype.setHealth=function(a){this._health=a};Agent.prototype.getEconomicHealth=function(){return this._economicHealth};Agent.prototype.setEconomicHealth=function(a){this._economicHealth=a};Agent.prototype.getEnvironmentalHealth=function(){return this._environmentalHealth};Agent.prototype.setEnvironmentalHealth=function(a){this._environmentalHealth=a};
Agent.prototype.getSocialHealth=function(){return this._socialHealth};Agent.prototype.setSocialHealth=function(a){this._socialHealth=a};Agent.prototype.getIsHit=function(){return this._isHit};Agent.prototype.setIsHit=function(a){this._isHit=a};
Agent.prototype.adjustHealth=function(a){this._economicHealth=this.makeHealthAdjustment(this._economicHealth,a);this._environmentalHealth=this.makeHealthAdjustment(this._environmentalHealth,a);this._socialHealth=this.makeHealthAdjustment(this._socialHealth,a);this.recalibrateOverallHealth()};Agent.prototype.adjustEconomicHealth=function(a){this._economicHealth=this.makeHealthAdjustment(this._economicHealth,a);this.recalibrateOverallHealth()};
Agent.prototype.adjustEnvironmentalHealth=function(a){this._environmentalHealth=this.makeHealthAdjustment(this._environmentalHealth,a);this.recalibrateOverallHealth()};Agent.prototype.adjustSocialHealth=function(a){this._socialHealth=this.makeHealthAdjustment(this._socialHealth,a);this.recalibrateOverallHealth()};Agent.prototype.makeHealthAdjustment=function(a,b){var c=a+b;return c>0&&c<INITIAL_HEALTH?c:c>0?INITIAL_HEALTH:0};
Agent.prototype.recalibrateOverallHealth=function(){var a=Math.floor((this._economicHealth+this._environmentalHealth+this._socialHealth)/3);this._health=a=this._economicHealth==0||this._environmentalHealth==0||this._socialHealth==0?0:a};Agent.prototype.getWanderX=function(){return this._wanderX};Agent.prototype.getWanderY=function(){return this._wanderY};
Agent.prototype.adjustWander=function(){var a=this._wanderX,b=this._wanderY,c=FiercePlanet.cellWidth/2-FiercePlanet.pieceWidth/2,d=Math.floor(Math.random()*3-1);a+=Math.floor(Math.random()*3-1);b+=d;if(c-Math.abs(a)>=0)this._wanderX=a;if(c-Math.abs(b)>=0)this._wanderY=b};Agent.prototype.getSpeed=function(){return this._speed};Agent.prototype.setSpeed=function(a){this._speed=a};Agent.prototype.getMoves=function(){return this._age};Agent.prototype.setMoves=function(a){this._age=a};
...
Agent.prototype.evaluatePosition=function(a){this.memorise(a,this._x,this._y)};
...
Agent.prototype.hasNeighbouringResources=function(a,b,c){for(var d=0;d<a.getResources().length;d++){var e=FiercePlanet.currentLevel.getResources()[d],f=e.getX(),g=e.getY();if(Math.abs(f-b)<=1&&Math.abs(g-c)<=1)return e}return null};function Level(a){this._id=a;this._isPresetLevel=!1;this._name=a;this._initialAgentNumber=1;this._entryPoints=[];this._exitPoints=[];this._worldHeight=this._worldWidth=11;this._waveNumber=10;this._expiryLimit=20;this._initialResourceStore=100;this._allowResouresOnPath=this._allowOffscreenCycling=!1;this._introduction="";this._soundSrc=this._noticeImage=null;this._tiles=[];this._tileMap=[];this._mapURL=this._mapOptions=null;this._customLevel=!1;this._levelAgents=[];this._waveAgents=[];this._currentAgents=[];this._currentAgentsMap=
[];this._cells=[];this._resources=[]}Level.prototype.getId=function(){return this._id};Level.prototype.setId=function(a){this._id=a};Level.prototype.isPresetLevel=function(){return this._isPresetLevel};Level.prototype.setPresetLevel=function(a){this._isPresetLevel=a};Level.prototype.getName=function(){return this._name};Level.prototype.setName=function(a){this._name=a};Level.prototype.getInitialAgentNumber=function(){return this._initialAgentNumber};
Level.prototype.setInitialAgentNumber=function(a){this._initialAgentNumber=a};Level.prototype.getEntryPoints=function(){return this._entryPoints};Level.prototype.setEntryPoints=function(a){this._entryPoints=a};Level.prototype.addEntryPoint=function(a,b){for(var c=!1,d=0;d<this._entryPoints.length;d++){var e=this._entryPoints[d];if(e[0]==a&&e[1]==b){c=!0;break}}c||this._entryPoints.push([a,b])};Level.prototype.resetEntryPoints=function(){this._entryPoints=[];this.addEntryPoint(0,0)};
Level.prototype.removeEntryPoint=function(a,b){for(var c=-1,d=0;d<this._entryPoints.length;d++){var e=this._entryPoints[d];e[0]==a&&e[1]==b&&(c=d)}c>-1&&this._entryPoints.splice(c,1)};Level.prototype.getFirstEntryPoint=function(){return this._entryPoints[0]};Level.prototype.getExitPoints=function(){return this._exitPoints};Level.prototype.setExitPoints=function(a){this._exitPoints=a};
Level.prototype.isExitPoint=function(a,b){for(var c=0;c<this._exitPoints.length;c++){var d=this._exitPoints[c];if(d[0]==a&&d[1]==b)return!0}return!1};Level.prototype.addExitPoint=function(a,b){for(var c=!1,d=0;d<this._exitPoints.length;d++){var e=this._exitPoints[d];if(e[0]==a&&e[1]==b){c=!0;break}}c||this._exitPoints.push([a,b])};Level.prototype.resetExitPoints=function(){this._exitPoints=[]};
Level.prototype.removeExitPoint=function(a,b){for(var c=-1,d=0;d<this._exitPoints.length;d++){var e=this._exitPoints[d];e[0]==a&&e[1]==b&&(c=d)}c>-1&&this._exitPoints.splice(c,1)};Level.prototype.getInitialResourceStore=function(){return this._initialResourceStore};Level.prototype.setInitialResourceStore=function(a){this._initialResourceStore=a};Level.prototype.getWorldWidth=function(){return this._worldWidth};Level.prototype.setWorldWidth=function(a){this._worldWidth=a};
Level.prototype.getWorldHeight=function(){return this._worldHeight};Level.prototype.setWorldHeight=function(a){this._worldHeight=a};Level.prototype.getWaveNumber=function(){return this._waveNumber};Level.prototype.setWaveNumber=function(a){this._waveNumber=a};Level.prototype.getExpiryLimit=function(){return this._expiryLimit};Level.prototype.setExpiryLimit=function(a){this._expiryLimit=a};Level.prototype.getAllowOffscreenCycling=function(){return this._allowOffscreenCycling};
Level.prototype.setAllowOffscreenCycling=function(a){this._allowOffscreenCycling=a};Level.prototype.getAllowResourcesOnPath=function(){return this._allowResouresOnPath};Level.prototype.setAllowResourcesOnPath=function(a){this._allowResouresOnPath=a};Level.prototype.getIntroduction=function(){return this._introduction};Level.prototype.setIntroduction=function(a){this._introduction=a};Level.prototype.getImage=function(){return this._noticeImage};Level.prototype.setImage=function(a){this._noticeImage=new Image;this._noticeImage.src=a};
Level.prototype.getSoundSrc=function(){return this._soundSrc};Level.prototype.setSoundSrc=function(a){this._soundSrc=a};Level.prototype.getTile=function(a,b){return this._tiles[b*this.getWorldWidth()+a]};Level.prototype.getSurroundingTiles=function(a,b){var c=[];a>0&&c.add(this.getTile(a-1,b));a<this._worldWidth-1&&c.add(this.getTile(a+1,b));b>0&&c.add(this.getTile(a,b-1));b<this._worldHeight-1&&c.add(this.getTile(a,b+1));return c};Level.prototype.getTiles=function(){return this._tiles};
...
Level.prototype.removeAllTiles=function(){for(var a=0;a<this.getWorldWidth();a++)for(var b=0;b<this.getWorldHeight();b++)this._tiles[b*this.getWorldWidth()+a]=void 0,this._cells[[a,b]]=void 0};Level.prototype.getMapOptions=function(){return this._mapOptions};Level.prototype.setMapOptions=function(a){this._mapOptions=a};Level.prototype.getMapURL=function(){return this._mapURL};Level.prototype.setMapURL=function(a){this._mapURL=a};Level.prototype.isCustomLevel=function(){return this._customLevel};
Level.prototype.setCustomLevel=function(a){this._customLevel=a};Level.prototype.getLevelAgents=function(){return this._levelAgents};Level.prototype.setLevelAgents=function(a){this._levelAgents=a};Level.prototype.addLevelAgent=function(a){this._levelAgents.push(a)};Level.prototype.getWaveAgents=function(){return this._waveAgents};Level.prototype.setWaveAgents=function(a){this._waveAgents=a};Level.prototype.addWaveAgent=function(a){this._waveAgents.push(a)};Level.prototype.getCurrentAgents=function(){return this._currentAgents};
Level.prototype.setCurrentAgents=function(a){this._currentAgents=a;for(var b in this._currentAgents)this._currentAgentsMap[b._id]=b};Level.prototype.getAgentByID=function(a){return this._currentAgentsMap[a]};Level.prototype.getResources=function(){return this._resources};Level.prototype.setResources=function(a){this._resources=a};Level.prototype.getCells=function(){return this._cells};Level.prototype.getCell=function(a,b){return this._cells[[a,b]]};
...
FiercePlanet.hookUpCustomEventListeners=function(){FiercePlanet.eventTarget.addListener("game",function(a){typeof console!="undefined"&&console.log("Game event "+a._event+" logged at:"+a._time)});FiercePlanet.eventTarget.addListener("resource",function(a){var b=a._source,a=a._levelContext;if(a.getId()==1){for(var a=a.getResources(),c=0,d=0,e=0,f=0;f<a.length;f++)switch(a[f].getType()){case "eco":c++;break;case "env":d++;break;case "soc":e++}switch(b.getType()){case "eco":if(c==1)FiercePlanet.currentNotice=
new Notice("Well done! You've added your first economic resource!"),FiercePlanet.currentNotice._backgroundColor="rgba(136, 201, 255)",FiercePlanet.currentNotice._foregroundColor="rgba(0, 0, 0)";break;case "env":if(d==1)FiercePlanet.currentNotice=new Notice("Well done! You've added your first environmental resource!"),FiercePlanet.currentNotice._backgroundColor="rgba(0, 255, 0)",FiercePlanet.currentNotice._foregroundColor="rgba(0, 0, 0)";break;case "soc":if(e==1)FiercePlanet.currentNotice=new Notice("Well done! You've added your first social resource!"),
FiercePlanet.currentNotice._foregroundColor="rgba(0, 0, 0)",FiercePlanet.currentNotice._backgroundColor="rgba(255, 51, 0)"}}})};function GameRecord(){this._levels=[];this._agents=[];this._resources=[];this._currentLevel={}};function Notice(a,b,c,d,e,f,g,h,j,k,n){this._text=a||"";this._start=d||FiercePlanet.gameCounter;this._duration=e||150;this._x=b||Math.random()*(FiercePlanet.WORLD_WIDTH-FiercePlanet.WAVE_NOTICE_WIDTH);this._y=c||Math.random()*(FiercePlanet.WORLD_HEIGHT-FiercePlanet.WAVE_NOTICE_HEIGHT);this._width=f||FiercePlanet.WAVE_NOTICE_WIDTH;this._height=g||FiercePlanet.WAVE_NOTICE_HEIGHT;this._backgroundColor=h||"rgba(32, 98, 210)";this._foregroundColor=j||"rgba(255, 255, 255)";this._lineWidth=k||2;this._font=
n||"500 16px/2 Unknown Font, sans-serif"};function PlayerClass(a,b){this._name=a;this._savesRequired=b}PlayerClass.prototype.getName=function(){return this._name};PlayerClass.prototype.setName=function(a){this._name=a};PlayerClass.prototype.getSavesRequired=function(){return this._savesRequired};PlayerClass.prototype.setSavesRequired=function(a){this._savesRequired=a};function ResourceKind(a,b,c,d,e,f,g){this._name=a;this._code=b;this._domain=c;this._cost=d;this._upgradeCost=e;this._totalYield=f;this._perAgentYield=g;this._color="000";if(c=="eco")this._color="99ccff";else if(c=="env")this._color="00ff00";else if(c=="soc")this._color="ff3300"}ResourceKind.prototype.getName=function(){return this._name};ResourceKind.prototype.setName=function(a){this._name=a};ResourceKind.prototype.getCode=function(){return this._code};
ResourceKind.prototype.setCode=function(a){this._code=a};ResourceKind.prototype.getDomain=function(){return this._domain};ResourceKind.prototype.setDomain=function(a){this._domain=a};ResourceKind.prototype.getCost=function(){return this._cost};ResourceKind.prototype.setCost=function(a){this._cost=a};ResourceKind.prototype.getUpgradeCost=function(){return this._upgradeCost};ResourceKind.prototype.setUpgradeCost=function(a){this._upgradeCost=a};ResourceKind.prototype.getPerAgentYield=function(){return this._perAgentYield};
ResourceKind.prototype.setPerAgentYield=function(a){this._perAgentYield=a};ResourceKind.prototype.getTotalYield=function(){return this._totalYield};ResourceKind.prototype.setTotalYield=function(a){this._totalYield=a};ResourceKind.prototype.getColor=function(){return this._color};ResourceKind.prototype.setColor=function(a){this._color=a};
function Resource(a,b,c){this._kind=a;this._resourceName=a.getCode();this._resourceType=a.getDomain();this._color=a.getColor();this._initialTotalYield=a.getTotalYield();this._perAgentYield=a.getPerAgentYield();this._cost=a.getCost();this._upgradeCost=a.getUpgradeCost();this._totalYield=a.getTotalYield();this._upgradeLevel=1;this.setPosition(b,c)}Resource.prototype.getName=function(){return this._resourceName};Resource.prototype.getType=function(){return this._resourceType};
...
Resource.prototype.getPerAgentYield=function(){return this._perAgentYield};Resource.prototype.setPerAgentYield=function(a){this._perAgentYield=a};Resource.prototype.getKind=function(){return this._kind};Resource.prototype.setKind=function(a){this._kind=a};Resource.prototype.getUpgradeLevel=function(){return this._upgradeLevel};Resource.prototype.setUpgradeLevel=function(a){this._upgradeLevel=a};Resource.prototype.getTotalYield=function(){return this._totalYield};
Resource.prototype.setTotalYield=function(a){this._totalYield=a};Resource.prototype.getPosition=function(){return[this._x,this._y]};Resource.prototype.setPosition=function(a,b){this._x=a;this._y=b};Resource.prototype.getX=function(){return this._x};Resource.prototype.setX=function(a){this._x=a};Resource.prototype.getY=function(){return this._y};Resource.prototype.setY=function(a){this._y=a};
Resource.prototype.provideYield=function(a,b){if(this._totalYield>this._perAgentYield&&a.getHealth()<100){if(FiercePlanet.applyGeneralHealth){var c=this._perAgentYield*this._upgradeLevel*b;a.adjustHealth(c)}else c=this._perAgentYield*this._upgradeLevel*3*b,this._resourceType=="eco"?a.adjustEconomicHealth(c):this._resourceType=="env"?a.adjustEnvironmentalHealth(c):this._resourceType=="soc"&&a.adjustSocialHealth(c);a.setSpeed(this._perAgentYield);this._totalYield-=this._perAgentYield}};var DEFAULT_TILE_COLOR="0FFF1F";function Tile(){this._color="0FFF1F"}function Tile(a){this._color=a}function Tile(a,b,c){this._color=a;this._x=b;this._y=c}Tile.prototype.getColor=function(){return this._color};Tile.prototype.getPosition=function(){return[this._x,this._y]};Tile.prototype.setPosition=function(a,b){this._x=a;this._y=b};Tile.prototype.getX=function(){return this._x};Tile.prototype.setX=function(a){this._x=a};Tile.prototype.getY=function(){return this._y};
Tile.prototype.setY=function(a){this._y=a};var FiercePlanet=FiercePlanet||{};
FiercePlanet.setupDialogs=function(){FiercePlanet.$statsDialog=$("<div></div>").dialog({autoOpen:!1,modal:!0,title:"Vital Statistics",buttons:{OK:function(){$(this).dialog("close")}}});FiercePlanet.$gameOver=$("<div></div>").html("Game Over!").dialog({autoOpen:!1,modal:!0,title:"Game Over!",buttons:{"Restart Level":function(){FiercePlanet.restartLevel();$(this).dialog("close")},"New Game":function(){FiercePlanet.newGame();$(this).dialog("close")}}});FiercePlanet.$newLevel=$("<div></div>").html("New Level").dialog({width:460,
autoOpen:!1,modal:!0,title:"New Level",buttons:{Play:function(){FiercePlanet.newWave();$(this).dialog("close")},Cancel:function(){$(this).dialog("close")}}});FiercePlanet.$completeLevel=$("<div></div>").html("Level Complete!").dialog({autoOpen:!1,modal:!0,title:"Level Complete!",buttons:{"Next Level":function(){FiercePlanet.newLevel();$(this).dialog("close")},Cancel:function(){FiercePlanet.newLevel();$(this).dialog("close")}}});FiercePlanet.$completeGame=$("<div></div>").html("Complete game!").dialog({autoOpen:!1,
modal:!0,title:"Fierce Planet Complete!",buttons:{"New Game":function(){FiercePlanet.newGame();$(this).dialog("close")},Cancel:function(){$(this).dialog("close")}}});FiercePlanet.$upgradeDelete=$("#delete-upgrade-dialog").dialog({autoOpen:!1,modal:!0,title:"Upgrade or Delete Resource",buttons:{Cancel:function(){$(this).dialog("close")}}});$("#del-button").click(function(){FiercePlanet.deleteCurrentResource();FiercePlanet.$upgradeDelete.dialog("close")});$("#upg-button").click(function(){FiercePlanet.upgradeCurrentResource();
FiercePlanet.$upgradeDelete.dialog("close")});FiercePlanet.$resourceGallery=$("#resource-gallery").dialog({width:460,autoOpen:!1,modal:!0,title:"Resource Gallery",buttons:{"Save Capabilities":function(){FiercePlanet.refreshSwatch();FiercePlanet.saveCapabilities();$(this).dialog("close")},Cancel:function(){$(this).dialog("close")}}});$settingsDialog=$("#settings-dialog").dialog({width:460,autoOpen:!1,modal:!0,title:"Settings",buttons:{"Save Settings":function(){FiercePlanet.setAndStoreProperties();
$(this).dialog("close")},Cancel:function(){$(this).dialog("close")}}});$("#tutorial").click(function(){FiercePlanet.currentLevelNumber=0;FiercePlanet.currentLevelPreset=!1;FiercePlanet.restartLevel()});FiercePlanet.$designFeatures=$("#level-features").dialog({autoOpen:!1,modal:!0,title:"Add design features",buttons:{Cancel:function(){$(this).dialog("close")}}});FiercePlanet.$editProperties=$("<div></div>").html("Edit level properties").dialog({autoOpen:!1,modal:!0,title:"Edit level properties",buttons:{"Save Level":function(){$(".edit_level_properties").submit();
FiercePlanet.drawGame();$(this).dialog("close")},Cancel:function(){$(this).dialog("close")}}})};FiercePlanet.showGameOverDialog=function(){FiercePlanet.determineCreditsAndClass();FiercePlanet.PROFILE_ID!=void 0?FiercePlanet.updateStats(function(){FiercePlanet.openGameOverDialog()}):FiercePlanet.openGameOverDialog()};
FiercePlanet.openGameOverDialog=function(){FiercePlanet.$gameOver.html("Unfortunately Fierce Planet has gotten the better of its citizens! Click 'Restart Level' or 'New Game' to try again."+FiercePlanet.generateStats()).dialog("open")};FiercePlanet.showCompleteGameDialog=function(){FiercePlanet.determineCreditsAndClass();if(FiercePlanet.PROFILE_ID!=void 0){var a=FiercePlanet.compileStats();$.post("/profiles/"+FiercePlanet.PROFILE_ID+"/update_stats",a,function(){FiercePlanet.openCompleteGameDialog()})}else FiercePlanet.openCompleteGameDialog()};
FiercePlanet.openCompleteGameDialog=function(){FiercePlanet.$completeGame.html("Congratulations! In spite of challenges ahead, the citizens of Fierce Planet look forward to a bright and sustainable future!"+FiercePlanet.generateStats()).dialog("open")};FiercePlanet.showCompleteLevelDialog=function(){FiercePlanet.determineCreditsAndClass();if(FiercePlanet.PROFILE_ID!=void 0){var a=FiercePlanet.compileStats();$.post("/profiles/"+FiercePlanet.PROFILE_ID+"/update_stats",a,function(){FiercePlanet.openCompleteLevelDialog()})}else FiercePlanet.openCompleteLevelDialog()};
FiercePlanet.openCompleteLevelDialog=function(){FiercePlanet.$completeLevel.html("<p>Congratulations! You have completed level "+FiercePlanet.currentLevel.getId()+". </p>"+FiercePlanet.generateStats()+"<p>Click 'OK' to start the next level.</p>").dialog("open")};
...
"Visionary")a=FiercePlanet.VISIONARY_CAPABILITIES;else if(FiercePlanet.profileClass=="Genius")a=FiercePlanet.GENIUS_CAPABILITIES;for(var c=$(".purchase"),d=0;d<c.length;d++){var e=c[d],f=e.id,f=f.split("-purchase")[0],g=0;$.inArray(f,FiercePlanet.PLANNER_CAPABILITIES)?g=FiercePlanet.CAPABILITY_COSTS[1]:$.inArray(f,FiercePlanet.EXPERT_CAPABILITIES)?g=FiercePlanet.CAPABILITY_COSTS[2]:$.inArray(f,FiercePlanet.VISIONARY_CAPABILITIES)?g=FiercePlanet.CAPABILITY_COSTS[3]:$.inArray(f,FiercePlanet.GENIUS_CAPABILITIES)&&
(g=FiercePlanet.CAPABILITY_COSTS[4]);$.inArray(f,a)>-1&&$.inArray(f,FiercePlanet.capabilities)==-1&&g<FiercePlanet.credits?b.push(e):$("#"+e.id).css("border","1px solid black")}for(d=0;d<b.length;d++)e=b[d],f=e.id,f=f.split("-purchase")[0],g=0,$.inArray(f,FiercePlanet.PLANNER_CAPABILITIES)?g=FiercePlanet.CAPABILITY_COSTS[1]:$.inArray(f,FiercePlanet.EXPERT_CAPABILITIES)?g=FiercePlanet.CAPABILITY_COSTS[2]:$.inArray(f,FiercePlanet.VISIONARY_CAPABILITIES)?g=FiercePlanet.CAPABILITY_COSTS[3]:$.inArray(f,
FiercePlanet.GENIUS_CAPABILITIES)&&(g=FiercePlanet.CAPABILITY_COSTS[4]),e.addEventListener("click",function(a){var b=this.id,c=b.split("-purchase")[0],d=$("#"+b+" > a > img")[0].title;if($.inArray(c,FiercePlanet.capabilities)==-1&&confirm('Purchase item "'+d+'"?'))FiercePlanet.credits-=g,FiercePlanet.capabilities.push(c),$("#current-credits")[0].innerHTML=FiercePlanet.credits,$("#current-capabilities")[0].innerHTML=FiercePlanet.capabilities.join(", "),$("#"+b).css("border","1px solid black");a.stopPropagation();
return!1},!0),$("#"+e.id).css("border","3px solid black");FiercePlanet.$resourceGallery.dialog("open")};FiercePlanet.showSettings=function(){$settingsDialog.dialog("open")};FiercePlanet=FiercePlanet||{};
...
FiercePlanet.drawNotice=function(){if(FiercePlanet.currentNotice!=null){FiercePlanet.clearCanvas("noticeCanvas");var a=$("#noticeCanvas")[0].getContext("2d"),b=FiercePlanet.currentNotice._text,c=FiercePlanet.currentNotice._start,d=FiercePlanet.currentNotice._duration,e=Math.pow((d-(FiercePlanet.gameCounter-c))/d-0.1,0.5),f=FiercePlanet.currentNotice._x,g=FiercePlanet.currentNotice._y,h=FiercePlanet.currentNotice._width,j=FiercePlanet.currentNotice._height,k=FiercePlanet.insertAlpha(FiercePlanet.currentNotice._foregroundColor,
e),e=FiercePlanet.insertAlpha(FiercePlanet.currentNotice._backgroundColor,e),n=FiercePlanet.currentNotice._lineWidth;a.font=FiercePlanet.currentNotice._font;a.lineWidth=n;a.clearRect(f-1,g-1,h+2,j+2);if(!(c>FiercePlanet.gameCounter||c+d<FiercePlanet.gameCounter)){a.beginPath();a.moveTo(f+10,g);a.lineTo(f+h-10,g);a.arcTo(f+h,g,f+h,g+10,10);a.lineTo(f+h,g+j-10);a.arcTo(f+h,g+j,f+h-10,g+j,10);a.lineTo(f+10,g+j);a.arcTo(f,g+j,f,g+j-10,10);a.lineTo(f,g+10);a.arcTo(f,g,f+10,g,10);a.closePath();a.strokeStyle=
...
FiercePlanet.getTextLines=function(a,b,c){var d=a.measureText(b).width;if(d<c)return[b];for(var d=b.length/Math.ceil(d/c),e=[],b=b.split(" "),f="",g=0;g<b.length;g++){var h=b[g];if(a.measureText(f+h+" ").width<c)f+=h+" ";else{if(f.length==0&&a.measureText(h).width>=d){var j=a.measureText(h).width,j=h.length/Math.ceil(j/c);f+=h.substring(0,j-1)+"-";h=h.substring(j,h.length);b.splice(g,0,h)}e.push(f);f=""}}e.push(f);return e};FiercePlanet.insertAlpha=function(a,b){return a.split(")").join(", "+b+")")};
FiercePlanet.drawResources=function(){for(var a=0;a<FiercePlanet.currentLevel._resources.length;a+=1)FiercePlanet.drawResource(FiercePlanet.currentLevel._resources[a])};
...
FiercePlanet.clearAgents=function(){var a=$("#agentCanvas")[0].getContext("2d"),b=FiercePlanet.currentLevel._currentAgents;if(FiercePlanet.waveCounter>0)for(var c=0;c<b.length;c+=1){var d=b[c],e=d._wanderX,f=d._wanderY,g=FiercePlanet.getDrawingPosition(d,FiercePlanet.waveCounter-1),h=g.intX*FiercePlanet.cellWidth+e+1,g=g.intY*FiercePlanet.cellHeight+f+1;a.clearRect(h,g,FiercePlanet.cellWidth+e+1,FiercePlanet.cellHeight+f+1);if(FiercePlanet.agentTracing)g=FiercePlanet.getDrawingPosition(d,FiercePlanet.waveCounter-
1),h=g.intX*FiercePlanet.cellWidth,g=g.intY*FiercePlanet.cellHeight,a.beginPath(),a.arc(h+FiercePlanet.cellWidth/2,g+FiercePlanet.cellHeight*1.2,2,0,Math.PI*2,!1),a.closePath(),a.strokeStyle="#000",a.stroke(),a.fillStyle="#000",a.fill()}};
...
FiercePlanet.getDrawingPosition=function(a,b){var c=a._lastMemory._x,d=a._lastMemory._y,e=a._x,f=a._y,g=a._speed,h=(g-(b-a._delay)%g)/g,g=e-(e-c)*h,j=f-(f-d)*h;if(FiercePlanet.currentLevel._allowOffscreenCycling){var k=h<0.5;e==FiercePlanet.worldWidth-1&&c==0?k?(f=(e-FiercePlanet.worldWidth)*h,g=e-f):g=1-h:e==0&&c==FiercePlanet.worldWidth-1?k?g=0-h:(f=(FiercePlanet.worldWidth-c)*h,g=FiercePlanet.worldWidth-f):f==FiercePlanet.worldWidth-1&&d==0?k?(e=(f-FiercePlanet.worldWidth)*h,j=f-e):j=1-h:f==0&&
d==FiercePlanet.worldWidth-1&&(k?j=0-h:(e=(FiercePlanet.worldWidth-d)*h,j=FiercePlanet.worldWidth-e))}return{intX:g,intY:j}};
...
f+FiercePlanet.cellHeight/4,g=FiercePlanet.getAgentDirection(d),h=FiercePlanet.diluteColour(d._socialHealth,d._environmentalHealth,d._economicHealth,d._color.toString());d._isHit&&(h="f00");try{eval(d.getType().getDrawFunction())(a,d,e,f,FiercePlanet.pieceWidth,FiercePlanet.pieceHeight,h,FiercePlanet.waveCounter,g)}catch(j){eval(AgentTypes.CITIZEN_AGENT_TYPE.getDrawFunction())(a,d,e,f,FiercePlanet.pieceWidth,FiercePlanet.pieceHeight,h,FiercePlanet.waveCounter,g)}}}};
FiercePlanet.drawScrollingLayer=function(){if(FiercePlanet.scrollingImageVisible){FiercePlanet.clearCanvas("scrollingCanvas");var a=$("#scrollingCanvas")[0].getContext("2d");FiercePlanet.scrollingImageX+FiercePlanet.scrollingImageOffset<480-FiercePlanet.scrollingImageOffset?FiercePlanet.scrollingImageX+=FiercePlanet.scrollingImageOffset:FiercePlanet.scrollingImageX=1;try{a.drawImage(FiercePlanet.scrollingImage,FiercePlanet.scrollingImageX,1,480,400,0,0,480,400)}catch(b){}}};
FiercePlanet.drawLevel=function(){$("#level-display")[0].innerHTML=FiercePlanet.currentLevel.getId()};FiercePlanet.drawProfileClass=function(){var a=$("#profile-class-display")[0];if(a!=void 0)a.innerHTML=FiercePlanet.profileClass};FiercePlanet.drawScore=function(){$("#score-display")[0].innerHTML=FiercePlanet.currentScore.toString()};FiercePlanet.drawHighestScore=function(){var a=$("#highest-score-display")[0],b=localStorage.highestScore;b==void 0&&(b=0);a.innerHTML=b.toString()};
FiercePlanet.drawResourcesInStore=function(){$("#goodness-display")[0].innerHTML=FiercePlanet.resourcesInStore.toString()};FiercePlanet.drawExpired=function(){$("#expired-display")[0].innerHTML=FiercePlanet.expiredAgentCount.toString()+" out of "+FiercePlanet.currentLevel.getExpiryLimit()};FiercePlanet.drawSaved=function(){$("#saved-display")[0].innerHTML=FiercePlanet.savedAgentCount.toString()};
...
FiercePlanet.clearAgents();for(var a=[],b=0,c=FiercePlanet.currentLevel.getCurrentAgents(),d=0;d<c.length;d++){var e=c[d],f=e.getSpeed();FiercePlanet.waveCounter>=e.getDelay()&&(FiercePlanet.waveCounter-e.getDelay())%f==0&&e.evaluatePosition(FiercePlanet.currentLevel)}for(var g={withNoRepeat:!0,withNoCollision:!1},d=0;d<c.length;d++)if(e=c[d],FiercePlanet.rivalsVisible||e.getType()!=AgentTypes.RIVAL_AGENT_TYPE)if(FiercePlanet.predatorsVisible||e.getType()!=AgentTypes.PREDATOR_AGENT_TYPE)if(f=e.getSpeed(),
e.getType()==AgentTypes.CITIZEN_AGENT_TYPE&&b++,FiercePlanet.waveCounter>=e.getDelay()&&(FiercePlanet.waveCounter-e.getDelay())%f==0){e.getType()==AgentTypes.CITIZEN_AGENT_TYPE&&FiercePlanet.currentLevel.isExitPoint(e.getX(),e.getY())&&(FiercePlanet.currentScore+=FiercePlanet.SAVE_SCORE,FiercePlanet.savedAgentCount++,FiercePlanet.savedAgentThisWaveCount++,a.push(d),FiercePlanet.resourcesInStore+=FiercePlanet.currentWave<5?4:FiercePlanet.currentWave<10?3:FiercePlanet.currentWave<20?2:1,FiercePlanet.drawScore(),
FiercePlanet.drawResourcesInStore(),FiercePlanet.drawSaved());e.evaluateMove(FiercePlanet.currentLevel,g);e.getType()==AgentTypes.CITIZEN_AGENT_TYPE&&(e.adjustSpeed(),e.adjustWander());if(e.getMoves()>FiercePlanet.maxWaveMoves)FiercePlanet.maxWaveMoves=e.getMoves();if(e.getType()==AgentTypes.CITIZEN_AGENT_TYPE||e.getType()==AgentTypes.RIVAL_AGENT_TYPE)FiercePlanet.godMode||e.adjustHealth(FiercePlanet.MOVE_HEALTH_COST),e.getHealth()<=0?(a.push(d),e.getType()==AgentTypes.CITIZEN_AGENT_TYPE&&FiercePlanet.expiredAgentCount++,
FiercePlanet.drawExpired()):(FiercePlanet.processNeighbouringResources(e),FiercePlanet.processNeighbouringAgents(e))}if(FiercePlanet.expiredAgentCount>=FiercePlanet.currentLevel.getExpiryLimit())return FiercePlanet.gameOver();for(d=a.length-1;d>=0;d-=1)FiercePlanet.currentLevel.getCurrentAgents().splice(a[d],1);if(b==0)if(FiercePlanet.currentWave<FiercePlanet.currentLevel.getWaveNumber())FiercePlanet.completeWave(),FiercePlanet.newWave();else if(FiercePlanet.currentLevelNumber<PresetLevels.MAX_DEFAULT_LEVELS)FiercePlanet.completeLevel(),
FiercePlanet.levelDelayCounter=0;else return FiercePlanet.completeGame();else FiercePlanet.waveCounter%FiercePlanet.resourceRecoveryCycle==0&&FiercePlanet.recoverResources(),FiercePlanet.drawAgents();FiercePlanet.recording&&FiercePlanet.recordWorld()}};
FiercePlanet.processNeighbouringResources=function(a){for(var b=a.getX(),c=a.getY(),d=0;d<FiercePlanet.currentLevel.getResources().length;d++){var e=FiercePlanet.currentLevel.getResources()[d],f=e.getX(),g=e.getY();Math.abs(f-b)<=1&&Math.abs(g-c)<=1&&(f=FiercePlanet.calculateResourceEffect(e),e.provideYield(a,f,FiercePlanet.applyGeneralHealth),FiercePlanet.drawResource(e))}};
...
FiercePlanet.getCurrentPosition=function(a){var b,c;if(a.layerX||a.layerX==0)b=a.layerX,c=a.layerY;else if(a.offsetX||a.offsetX==0)b=a.offsetX,c=a.offsetY;b-=FiercePlanet.panLeftOffset;c-=FiercePlanet.panTopOffset;b/=FiercePlanet.zoomLevel;c/=FiercePlanet.zoomLevel;b/=FiercePlanet.externalZoomLevel;c/=FiercePlanet.externalZoomLevel;b-=1/FiercePlanet.zoomLevel;c-=1/FiercePlanet.zoomLevel;return{posX:Math.floor(b/FiercePlanet.cellWidth),posY:Math.floor(c/FiercePlanet.cellHeight)}};
FiercePlanet.notify=function(a){$("#notifications")[0].innerHTML=a};FiercePlanet.levelInfo=function(a){FiercePlanet.$newLevel.html("<p>"+a+"</p>").dialog("open")};FiercePlanet.refreshSwatch=function(){for(var a=0;a<FiercePlanet.capabilities.length;a++){var b=$.trim(FiercePlanet.capabilities[a]);try{var c=$("#"+b);c.removeClass("inactive");makeResourceActive(c[0])}catch(d){}}};FiercePlanet=FiercePlanet||{};FiercePlanet.loadGame=function(){FiercePlanet.loadSettingsFromStorage();FiercePlanet.setupDialogs();FiercePlanet.setupResourceInteraction();FiercePlanet.hookUpUIEventListeners();FiercePlanet.hookUpCustomEventListeners();FiercePlanet.newLevel()};FiercePlanet.newGame=function(){if(FiercePlanet.currentLevelPreset)FiercePlanet.currentLevelNumber=1;FiercePlanet.currentScore=0;FiercePlanet.previousLevelScore=0;FiercePlanet.gameCounter=0;FiercePlanet.newLevel()};
FiercePlanet.newLevel=function(){FiercePlanet.inDesignMode=!1;FiercePlanet.levelDelayCounter=0;FiercePlanet.levelCounter=0;FiercePlanet.maxLevelMoves=0;FiercePlanet.previousLevelScore=FiercePlanet.currentScore;FiercePlanet.currentLevel!=void 0&&FiercePlanet.currentLevel.setResources([]);FiercePlanet.recordedLevels=[];FiercePlanet._initialiseGame();FiercePlanet.levelInfo(FiercePlanet.currentLevel.getIntroduction());FiercePlanet.notify("Starting level "+FiercePlanet.currentLevel.getId()+"...")};
FiercePlanet.restartLevel=function(){FiercePlanet.currentScore=FiercePlanet.previousLevelScore;FiercePlanet.newLevel()};
FiercePlanet.newWave=function(){FiercePlanet.maxWaveMoves=0;FiercePlanet.waveCounter=0;FiercePlanet.waveDelayCounter=0;FiercePlanet.savedAgentThisWaveCount=0;FiercePlanet.currentLevel.presetAgents(AgentTypes.CITIZEN_AGENT_TYPE,FiercePlanet.numAgents,FiercePlanet.agentsCanCommunicate);FiercePlanet.notify("New wave coming...");FiercePlanet.drawEntryPoints();FiercePlanet.drawExitPoints();FiercePlanet.eventTarget.fire(new Event("game",this,"newWave",$fp.gameCounter,FiercePlanet.currentLevel));FiercePlanet._startAgents()};
...
FiercePlanet.completeGame=function(){FiercePlanet._finaliseGame();FiercePlanet.showCompleteGameDialog()};FiercePlanet.playGame=function(){FiercePlanet.inPlay?FiercePlanet.pauseGame():FiercePlanet.waveCounter==0?FiercePlanet.newWave():FiercePlanet._startAgents()};FiercePlanet.pauseGame=function(){FiercePlanet.inPlay&&FiercePlanet._stopAgents()};
...
FiercePlanet.scrollingImageVisible=!0;FiercePlanet.agentsCanCommunicate=!0;FiercePlanet.godMode=!1;FiercePlanet.invisiblePath=!1;FiercePlanet.noticesVisible=!1;FiercePlanet.agentTracing=!1;FiercePlanet.recording=!1;FiercePlanet.soundsPlayable=!1;FiercePlanet.resourcesInTension=!1;FiercePlanet.resourceBonus=!1;FiercePlanet.predatorsVisible=!1;FiercePlanet.rivalsVisible=!1;FiercePlanet.backgroundIconsVisible=!1;FiercePlanet.applyGeneralHealth=!1;FiercePlanet.ignoreResourceBalance=!1;
FiercePlanet.tilesMutable=!1;FiercePlanet.agentTimerId=0;FiercePlanet.eventTarget=new EventTarget;FiercePlanet.recordedLevels=[];FiercePlanet.currentLevelNumber=1;FiercePlanet.currentWave=1;FiercePlanet.currentLevelPreset=!0;FiercePlanet.currentLevel=null;FiercePlanet.existingCurrentLevel=null;FiercePlanet.currentResourceId=null;FiercePlanet.currentResource=null;FiercePlanet.currentNotice=null;FiercePlanet.waveOverride=0;FiercePlanet.maxWaveMoves=0;FiercePlanet.maxLevelMoves=0;
FiercePlanet.levelOfDifficulty=FiercePlanet.MEDIUM_DIFFICULTY;FiercePlanet.resourceRecoveryCycle=5;FiercePlanet.interval=50;FiercePlanet.levelDelayCounter=0;FiercePlanet.waveDelayCounter=0;FiercePlanet.numAgents=1;FiercePlanet.economicResourceCount=0;FiercePlanet.environmentalResourceCount=0;FiercePlanet.socialResourceCount=0;FiercePlanet.waveCounter=0;FiercePlanet.levelCounter=0;FiercePlanet.gameCounter=0;FiercePlanet.globalRecordingCounter=0;FiercePlanet.previousLevelScore=0;
FiercePlanet.currentScore=0;FiercePlanet.resourcesInStore=0;FiercePlanet.resourcesSpent=0;FiercePlanet.expiredAgentCount=0;FiercePlanet.savedAgentCount=0;FiercePlanet.savedAgentThisWaveCount=0;FiercePlanet.zoomLevel=1;FiercePlanet.externalZoomLevel=1;FiercePlanet.panLeftOffset=0;FiercePlanet.panTopOffset=0;FiercePlanet.worldWidth=14;FiercePlanet.worldHeight=11;FiercePlanet.cellWidth=FiercePlanet.WORLD_WIDTH/FiercePlanet.worldWidth;FiercePlanet.cellHeight=FiercePlanet.WORLD_HEIGHT/FiercePlanet.worldHeight;
FiercePlanet.pieceWidth=FiercePlanet.cellWidth*0.5;FiercePlanet.pieceHeight=FiercePlanet.cellHeight*0.5;FiercePlanet.scrollingImage=new Image;FiercePlanet.scrollingImageX=0;FiercePlanet.scrollingImageOffset=1;FiercePlanet.audio=null;FiercePlanet.googleMap=null;FiercePlanet.currentX=null;FiercePlanet.currentY=null;FiercePlanet.$gameOver=null;FiercePlanet.$completeLevel=null;FiercePlanet.$completeGame=null;FiercePlanet.$levelList=null;FiercePlanet.$upgradeDelete=null;FiercePlanet.$resourceGallery=null;
FiercePlanet.$newLevel=null;FiercePlanet.$designFeatures=null;FiercePlanet.$editProperties=null;FiercePlanet=FiercePlanet||{};FiercePlanet.loadSettingsFromStorage=function(){FiercePlanet.currentLevelNumber=localStorage.currentLevelNumber!=void 0?parseInt(localStorage.currentLevelNumber):FiercePlanet.currentLevelNumber;FiercePlanet.currentLevelPreset=localStorage.currentLevelPreset!=void 0?localStorage.currentLevelPreset==="true":FiercePlanet.currentLevelPreset;FiercePlanet.currentScore=localStorage.currentScore!=void 0?parseInt(localStorage.currentScore):FiercePlanet.currentScore};
...
resources_in_store:FiercePlanet.resourcesInStore,resources:a,economic_resources:FiercePlanet.economicResourceCount,environmental_resources:FiercePlanet.environmentalResourceCount,social_resources:FiercePlanet.socialResourceCount,progress_towards_next_class:0}};
...
FiercePlanet.resourcesInStore+"</td></tr><tr><td></td><td></td></tr><tr><td>Total saved:</td><td>"+FiercePlanet.totalSaved+"</td></tr><tr><td>Profile class:</td><td>"+FiercePlanet.profileClass+"</td></tr><tr><td>Credits:</td><td>"+FiercePlanet.credits+"</td></tr></table>"};FiercePlanet.updateStats=function(a){var b=FiercePlanet.compileStats();$.post("/profiles/"+FiercePlanet.PROFILE_ID+"/update_stats",b,a)};FiercePlanet.saveCapabilities=function(){FiercePlanet.PROFILE_ID!=void 0&&FiercePlanet.updateStats(function(){})};FiercePlanet=FiercePlanet||{};
...
FiercePlanet.dropItem=function(a){var b=FiercePlanet.getCurrentPosition(a),c=b.posX,b=b.posY;if((FiercePlanet.currentLevel.getCell(c,b)!=void 0||FiercePlanet.currentLevel.getAllowResourcesOnPath())&&!(FiercePlanet.currentLevel.getCell(c,b)instanceof Resource)){var d=FiercePlanet.currentResourceId;a.dataTransfer&&(d=a.dataTransfer.getData("Text"));a=FiercePlanet.resolveResourceKind(d);a=new Resource(a,c,b);FiercePlanet.resourcesInStore<a.getCost()?FiercePlanet.notify("Not enough goodness for now - save some more agents!"):
(FiercePlanet.resourcesInStore-=a.getCost(),FiercePlanet.resourcesSpent+=a.getCost(),FiercePlanet.currentLevel.getResources().push(a),a.getType()=="eco"?FiercePlanet.economicResourceCount+=1:a.getType()=="env"?FiercePlanet.environmentalResourceCount+=1:a.getType()=="soc"&&(FiercePlanet.socialResourceCount+=1),FiercePlanet.currentLevel.addCell(c,b,a),FiercePlanet.drawResource(a),FiercePlanet.drawResourcesInStore(),FiercePlanet.eventTarget.fire(new Event("resource",a,"added",FiercePlanet.gameCounter,
FiercePlanet.currentLevel)))}};FiercePlanet.getCurrentResourceIndex=function(){for(var a=0;a<FiercePlanet.currentLevel.getResources().length;a++)if(FiercePlanet.currentLevel.getResources()[a]==FiercePlanet.currentResource)return a;return-1};
FiercePlanet.calculateResourceEffect=function(a){if(FiercePlanet.ignoreResourceBalance||FiercePlanet.applyGeneralHealth)return 1;var b=a.getType(),c=0,d=FiercePlanet.currentLevel.getResources().length;if(d==1)return 1;if(b=="eco")c=FiercePlanet.economicResourceCount;else if(b=="env")c=FiercePlanet.environmentalResourceCount;else if(b=="soc")c=FiercePlanet.socialResourceCount;b=c/d*d;d=b<=1?b:(d-b)/(d-1);d*=d;FiercePlanet.resourcesInTension&&(d*=FiercePlanet.calculateSurroundingResourcesEffects(a));
return d};FiercePlanet.calculateSurroundingResourcesEffects=function(a){for(var b=a.getX(),c=a.getY(),a=a.getType(),d=1,e=0;e<FiercePlanet.currentLevel.getResources().length;e++){var f=FiercePlanet.currentLevel.getResources()[e],g=f.getX(),h=f.getY(),f=f.getType();Math.abs(g-b)<=1&&Math.abs(h-c)<=1&&(a=="eco"?f=="eco"?d*=1.2:f=="env"?d*=1:f=="soc"&&(d*=1):a=="env"?f=="eco"?d*=0.5:f=="env"?d*=1.2:f=="soc"&&(d*=1):a=="soc"&&(f=="eco"?d*=0.5:f=="env"?d*=1:f=="soc"&&(d*=1.2)))}return d};
FiercePlanet.recoverResources=function(){for(var a=0;a<FiercePlanet.currentLevel.getResources().length;a++){var b=FiercePlanet.currentLevel.getResources()[a];b.getTotalYield()<b.getInitialTotalYield()&&(b.setTotalYield(b.getTotalYield()+1),FiercePlanet.drawResource(b))}};FiercePlanet.resetResourceYields=function(){for(var a=0;a<FiercePlanet.currentLevel.getResources().length;a++){var b=FiercePlanet.currentLevel.getResources()[a];b.setTotalYield(b.getInitialTotalYield())}};FiercePlanet=FiercePlanet||{};$(document).ajaxSend(function(a,b,c){if(c.type=="post")c.data=(c.data?c.data+"&":"")+"authenticity_token="+encodeURIComponent(AUTH_TOKEN)});$(function(){$().zoom(function(a){switch(a){case 1:FiercePlanet.externalZoomLevel*=1.2;break;case -1:FiercePlanet.externalZoomLevel/=1.2;break;case 0:FiercePlanet.externalZoomLevel=1}})});FiercePlanet.checkInteger=function(a){return Math.floor(a)};
...
FiercePlanet.getAndRetrieveProperties=function(){FiercePlanet.getAndRetrieveProperty("godMode");FiercePlanet.getAndRetrieveProperty("invisiblePath");FiercePlanet.getAndRetrieveProperty("agentsCanCommunicate");FiercePlanet.getAndRetrieveProperty("agentTracing");FiercePlanet.getAndRetrieveProperty("scrollingImageVisible");FiercePlanet.getAndRetrieveProperty("noticesVisible");FiercePlanet.getAndRetrieveProperty("recording");FiercePlanet.getAndRetrieveProperty("rivalsVisible");FiercePlanet.getAndRetrieveProperty("predatorsVisible");
FiercePlanet.getAndRetrieveProperty("tilesMutable");FiercePlanet.getAndRetrieveProperty("soundsPlayable");FiercePlanet.getAndRetrieveProperty("backgroundIconsVisible");FiercePlanet.getAndRetrieveProperty("resourcesInTension");FiercePlanet.getAndRetrieveProperty("resourceBonus");FiercePlanet.getAndRetrieveProperty("applyGeneralHealth");FiercePlanet.getAndRetrieveProperty("ignoreResourceBalance")};
...
Math.PI/180)*e/2,f=Math.cos(45*Math.PI/180)*e/2,a.moveTo(c-h,d+b+e/6+f),a.lineTo(c,d+b+e/6),a.moveTo(c+h,d+b+e/6+f),a.lineTo(c,d+b+e/6));a.closePath();a.strokeStyle="#"+g;a.lineWidth=2;a.stroke()});FiercePlanet=FiercePlanet||{};FiercePlanet.novice=new PlayerClass("Novice",0);FiercePlanet.teamLeader=new PlayerClass("Team Leader",200);FiercePlanet.planner=new PlayerClass("Planner",500);FiercePlanet=FiercePlanet||{};FiercePlanet.FARM_RESOURCE_KIND=new ResourceKind("Farm","farm","eco",10,20,100,20);FiercePlanet.SHOP_RESOURCE_KIND=new ResourceKind("Shop","shop","eco",15,25,100,30);FiercePlanet.BANK_RESOURCE_KIND=new ResourceKind("Bank","bank","eco",20,30,100,50);FiercePlanet.FACTORY_RESOURCE_KIND=new ResourceKind("Factory","factory","eco",25,40,100,70);FiercePlanet.STOCKMARKET_RESOURCE_KIND=new ResourceKind("Stockmarket","stockmarket","eco",30,50,100,90);
FiercePlanet.FRESH_WATER_RESOURCE_KIND=new ResourceKind("Fresh Water","water","env",10,20,100,10);FiercePlanet.WILDLIFE_PARK_RESOURCE_KIND=new ResourceKind("Wildlife Park","park","env",15,25,100,15);FiercePlanet.CLEAN_AIR_RESOURCE_KIND=new ResourceKind("Clear Air","air","env",20,30,100,25);FiercePlanet.GREEN_ENERGY_RESOURCE_KIND=new ResourceKind("Green Energy","energy","env",25,40,100,35);FiercePlanet.BIODIVERSITY_RESOURCE_KIND=new ResourceKind("Biodiversity","biodiversity","env",30,50,100,45);
FiercePlanet.CLINIC_RESOURCE_KIND=new ResourceKind("Clinic","clinic","soc",10,20,100,5);FiercePlanet.SCHOOL_RESOURCE_KIND=new ResourceKind("School","school","soc",15,25,100,8);FiercePlanet.LEGAL_SYSTEM_RESOURCE_KIND=new ResourceKind("Legal System","legal","soc",20,30,100,15);FiercePlanet.DEMOCRACY_RESOURCE_KIND=new ResourceKind("Democracy","democracy","soc",25,40,100,20);FiercePlanet.FESTIVAL_RESOURCE_KIND=new ResourceKind("Festival","festival","soc",30,50,100,25);
FiercePlanet.ECONOMIC_RESOURCE_KINDS=[FiercePlanet.FARM_RESOURCE_KIND,FiercePlanet.SHOP_RESOURCE_KIND,FiercePlanet.BANK_RESOURCE_KIND,FiercePlanet.FACTORY_RESOURCE_KIND,FiercePlanet.STOCKMARKET_RESOURCE_KIND];FiercePlanet.ENVIRONMENTAL_RESOURCE_KINDS=[FiercePlanet.FRESH_WATER_RESOURCE_KIND,FiercePlanet.WILDLIFE_PARK_RESOURCE_KIND,FiercePlanet.CLEAN_AIR_RESOURCE_KIND,FiercePlanet.GREEN_ENERGY_RESOURCE_KIND,FiercePlanet.BIODIVERSITY_RESOURCE_KIND];
FiercePlanet.SOCIAL_RESOURCE_KINDS=[FiercePlanet.CLINIC_RESOURCE_KIND,FiercePlanet.SCHOOL_RESOURCE_KIND,FiercePlanet.LEGAL_SYSTEM_RESOURCE_KIND,FiercePlanet.DEMOCRACY_RESOURCE_KIND,FiercePlanet.FESTIVAL_RESOURCE_KIND];FiercePlanet.RESOURCE_KINDS=FiercePlanet.ECONOMIC_RESOURCE_KINDS.concat(FiercePlanet.ENVIRONMENTAL_RESOURCE_KINDS.concat(FiercePlanet.SOCIAL_RESOURCE_KINDS));
FiercePlanet.resolveResourceKind=function(a){for(var b=0;b<FiercePlanet.RESOURCE_KINDS.length;b++){var c=FiercePlanet.RESOURCE_KINDS[b];if(c._code==a)return c}return null};var PresetLevels=function(){};PresetLevels.MAX_DEFAULT_LEVELS=10;PresetLevels.level0=new Level(0);PresetLevels.level0.setPresetLevel(!0);PresetLevels.level0.addEntryPoint(0,0);PresetLevels.level0.addExitPoint(4,4);PresetLevels.level0.setWorldWidth(5);PresetLevels.level0.setWorldHeight(5);PresetLevels.level0.setInitialAgentNumber(1);PresetLevels.level0.setWaveNumber(3);PresetLevels.level0.setExpiryLimit(20);PresetLevels.level0.setIntroduction("<h2>Tutorial</h2> <p>The aim of Fierce Planet is to help citizens survive as they move towards their goal (the yellow disc in the bottom right corner).</p> <p>You can do this by placing <em>resources</em> on the grey squares. Your resources are the blue, green and red rectangles below. You can click or drag resources onto any grey square on the game map.</p> <p>Resources come in three kinds: economic, environmental and social. Your citizens need all of these, so you will need to supply a mix of resources along their path.</p> <p>Notice that if you don't provide enough resources of a particular kind, your citizens will start to turn into that colour. That's a dangerous sign, which indicates you need to place some resources quickly.</p> <p>During game play, you spend resources from your store, indicated in the top left corner of the scoreboard. Saving citizens will increase your store.</p> <p>Start by placing some resources on the map. When you are ready, click the 'Start' button in the Control Panel on the left. A small number of citizens will make their way along the path.</p> ");
...
PresetLevels.level1.setIntroduction("<h2>Level 1: Welcome to Fierce Planet!</h2> <p>The citizens of Fierce Planet are under threat. They are migrating in ever increasing numbers, seeking a promised land of peace and prosperity.</p><p>Help them by placing 'Economic', 'Environmental' and 'Social' resources beside their path before they expire! Drag or click the blue, green and red swatches onto the grey patches of the maze.</p> <p><em>Tip: Keep watch on your resource and expired levels - once the maximum number of citizens have expired, it's Game Over!</em></p> ");
...
PresetLevels.level2.addEntryPoint(0,0);PresetLevels.level2.addExitPoint(11,1);PresetLevels.level2.setWorldWidth(12);PresetLevels.level2.setWorldHeight(12);PresetLevels.level2.setInitialAgentNumber(1);PresetLevels.level2.setWaveNumber(10);PresetLevels.level2.setExpiryLimit(10);PresetLevels.level2.setInitialResourceStore(120);PresetLevels.level2.setIntroduction("<h2>Level 2: Twists and Turns</h2><p>Congratulations! You successfully navigated Level 1!</p><p>The citizens of Fierce Planet now face a greater challenge... Can you supply them with resources to reach their goal?</p><p><em>Tip: you can pause at any time to add resources. Your resource store increases as you save more citizens.</em></p>");
...
this.clearTiles(13,1);this.clearTiles(0,2)};PresetLevels.level3=new Level(3);PresetLevels.level3.setPresetLevel(!0);PresetLevels.level3.addEntryPoint(5,12);PresetLevels.level3.addExitPoint(3,3);PresetLevels.level3.setWorldWidth(13);PresetLevels.level3.setWorldHeight(13);PresetLevels.level3.setInitialAgentNumber(1);PresetLevels.level3.setWaveNumber(10);PresetLevels.level3.setExpiryLimit(10);PresetLevels.level3.setInitialResourceStore(130);PresetLevels.level3.setIntroduction("<h2>Level 3: Around and About</h2><p>After some further twists, the citizens of Fierce Planet are about to embark on some long roads ahead....</p><p><em>Tip: Levels get progressively larger, requiring more planning about where you allocate resources. Aim to place resources at regular intervals.</em></p>");
...
PresetLevels.level4.setInitialAgentNumber(1);PresetLevels.level4.setWaveNumber(10);PresetLevels.level4.setExpiryLimit(10);PresetLevels.level4.setInitialResourceStore(150);PresetLevels.level4.setIntroduction("<h2>Level 4: Spiral of uncertainty</h2><p>The only way out is via the long and winding road...</p><p><em>Tip: be sure to allocate plenty of resources to the outer reaches of the road. The citizens will start to sprint when there is less to go around.</em></p>");
...
PresetLevels.level5.setIntroduction("<h2>Level 5: A-mazing Grace</h2><p>The citizens are -mistakenly? - hopeful that the promised land lies not too far ahead. If only they can find their way through...</p><p><em>Citizens are (sort of) smart - at forks in the road, they'll take the path which appears more plentiful. Place resources to help them choose the right path.</em>.</p>");
...
PresetLevels.level6.setAllowOffscreenCycling(!0);PresetLevels.level6.setInitialResourceStore(250);PresetLevels.level6.setIntroduction("<h2>Level 6: Dire Straits</h2><p>Not there yet... This level looks well resourced - but your citizens will need them. </p><p><em>Tip: Clicking on an existing resource allows you to delete or upgrade it. An upgraded resource will dispense more health to citizens passing by.</em></p>");
...
15)};PresetLevels.level7=new Level(7);PresetLevels.level7.setPresetLevel(!0);PresetLevels.level7.setWorldWidth(17);PresetLevels.level7.setWorldHeight(17);PresetLevels.level7.addEntryPoint(0,8);PresetLevels.level7.addExitPoint(16,8);PresetLevels.level7.setInitialAgentNumber(1);PresetLevels.level7.setWaveNumber(10);PresetLevels.level7.setExpiryLimit(10);PresetLevels.level7.setAllowResourcesOnPath(!0);PresetLevels.level7.setInitialResourceStore(150);PresetLevels.level7.setIntroduction("<h2>Level 7: Like, Totally Random...</h2><p>Ahead lies a vast and empty expanse. The citizens are understandably nervous. Left unaided, they will try not to backtrack, but could still find themselves hopelessly lost without your aid.</p><p><em>You can add resources to the paths (the white squares) on this level, to direct citizens to their goal.</em></p>");
PresetLevels.level7.setup=function(){this.fillWithTiles();this.clearTiles(280,1);this.clearTiles(262,3);this.clearTiles(244,5);this.clearTiles(226,7);this.clearTiles(208,9);this.clearTiles(190,11);this.clearTiles(172,13);this.clearTiles(154,15);this.clearTiles(136,17);this.clearTiles(120,15);this.clearTiles(104,13);this.clearTiles(88,11);this.clearTiles(72,9);this.clearTiles(56,7);this.clearTiles(40,5);this.clearTiles(24,3);this.clearTiles(8,1);this.addLevelAgent(new Agent(AgentTypes.PREDATOR_AGENT_TYPE,
8,4));this.addWaveAgent(new Agent(AgentTypes.RIVAL_AGENT_TYPE,9,4))};PresetLevels.level8=new Level(8);PresetLevels.level8.setPresetLevel(!0);PresetLevels.level8.addEntryPoint(0,0);PresetLevels.level8.addExitPoint(17,17);PresetLevels.level8.setWorldWidth(18);PresetLevels.level8.setWorldHeight(18);PresetLevels.level8.setInitialAgentNumber(1);PresetLevels.level8.setWaveNumber(10);PresetLevels.level8.setExpiryLimit(10);PresetLevels.level8.setInitialResourceStore(200);PresetLevels.level8.setIntroduction("<h2>Level 8: A Fork (or Two) in the Road</h2><p>Life for the citizens of Fierce Planet is never easy. Having escaped the perils of random wandering, here they are faced with many decisions about which way to turn.</p><p><em>Again, you'll need to direct citizen through numerous forks in the road, with strategic allocation of resources. Beware: leave no path under-resourced!</em></p>");
...
PresetLevels.level9.setIntroduction("<h2>Level 9: Cascades</h2><p>With time running out, the citizens of Fierce Planet are in a rush to find safety. But they're in for a bumpy ride.</p><p><em>Tip: No tip! You've gotten this far...</em></p>");
PresetLevels.level9.setup=function(){this.fillWithTiles();this.clearTiles(351,1);this.clearTiles(330,5);this.clearTiles(315,1);this.clearTiles(311,1);this.clearTiles(296,3);this.clearTiles(290,3);this.clearTiles(279,1);this.clearTiles(271,1);this.clearTiles(260,3);this.clearTiles(250,3);this.clearTiles(243,1);this.clearTiles(231,1);this.clearTiles(224,3);this.clearTiles(210,3);this.clearTiles(207,1);this.clearTiles(191,1);this.clearTiles(182,7);this.clearTiles(172,7);this.clearTiles(163,1);this.clearTiles(159,
1);this.clearTiles(144,3);this.clearTiles(138,3);this.clearTiles(127,1);this.clearTiles(119,1);this.clearTiles(108,3);this.clearTiles(98,3);this.clearTiles(91,1);this.clearTiles(79,1);this.clearTiles(72,3);this.clearTiles(58,3);this.clearTiles(55,1);this.clearTiles(39,1);this.clearTiles(20,17);this.clearTiles(9,1)};PresetLevels.level10=new Level(10);PresetLevels.level10.setPresetLevel(!0);PresetLevels.level10.addEntryPoint(18,19);PresetLevels.level10.addExitPoint(16,19);PresetLevels.level10.setWorldWidth(20);
PresetLevels.level10.setWorldHeight(20);PresetLevels.level10.setInitialAgentNumber(1);PresetLevels.level10.setWaveNumber(5);PresetLevels.level10.setExpiryLimit(1);PresetLevels.level10.setInitialResourceStore(250);PresetLevels.level10.setIntroduction("<h2>Level 10: Fields of Ma(i)ze</h2><p>Nearly there! Pastures of plenty, and a new future, lie in store for the citizens of Fierce Planet. However the way ahead is full of false dawns. Can they navigate the treacherous maze?</p><p><em>Tip: Remember to resource dead end paths, or citizens will expire, dazed and confused.</em></p>");
...
1);this.clearTiles(84,1);this.clearTiles(81,1);this.clearTiles(78,1);this.clearTiles(76,1);this.clearTiles(71,4);this.clearTiles(68,2);this.clearTiles(63,4);this.clearTiles(61,1);this.clearTiles(58,1);this.clearTiles(56,1);this.clearTiles(41,1);this.clearTiles(21,18)};PresetLevels.level1.setMapOptions({latitude:47.5153,longitude:19.0782,zoom:20});PresetLevels.level2.setMapOptions({latitude:37.390296,longitude:-5.954579,zoom:18});
PresetLevels.level3.setMapOptions({latitude:45.433607,longitude:12.338124,zoom:18});PresetLevels.level4.setMapOptions({latitude:-33.909092,longitude:18.406061,zoom:19});PresetLevels.level5.setMapOptions({latitude:-33.434969,longitude:-70.655254});PresetLevels.level6.setMapOptions({latitude:47.487229,longitude:19.07513});PresetLevels.level7.setMapOptions({latitude:30.006533,longitude:-90.158792});PresetLevels.level8.setMapOptions({latitude:21.283355,longitude:-157.837787});
