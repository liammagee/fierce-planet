...
m.le=function(){typeof console!="undefined"&&console.log("Initialising world...");m.hc();if(m.Aa&&(m.I<0||m.I>11))m.I=1;if(m.Aa)try{m.a=eval("PresetLevels.level"+m.I.toString())}catch(b){m.a=eval("PresetLevels.level1")}else if(m.a==a)m.a=eval("PresetLevels.level1");if(m.Ld>0)m.a.u=m.Ld,m.Ld=0;m.Pa=1;Ia(m.a,[]);var c=m.a;c.k=[];c.ec=c.ec||[];for(var d in c.ec)c.k.push(c.ec[d]);c.Ta=za(c);if(m.a.Ka!=a)m.a.Ka.Sc=!1;c=m.c;c.vb=0;c.gb=0;c.Ea=m.a.ka||m.ce;c.hb=0;c.ub={};for(d=0;d<E.w.length;d++)c.ub[E.w[d].j]=
