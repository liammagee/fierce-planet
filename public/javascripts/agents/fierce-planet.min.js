...
FiercePlanet.$editProperties=$("<div></div>").html("Edit level properties").dialog({position:[a,110],width:487,height:407,autoOpen:!1,modal:!0,title:"Edit level properties",buttons:{"Save Level":function(){$(".edit_level_properties").submit();FiercePlanet.drawGame();$(this).dialog("close")},Cancel:function(){$(this).dialog("close")}}})};FiercePlanet.showGameOverDialog=function(){FiercePlanet.currentProfile.id>-1?FiercePlanet.updateStats(function(){FiercePlanet.openGameOverDialog()}):FiercePlanet.openGameOverDialog()};
FiercePlanet.openGameOverDialog=function(){FiercePlanet.$gameOver.html("Unfortunately Fierce Planet has gotten the better of its citizens! Click 'Restart Level' or 'New Game' to try again."+FiercePlanet.generateStats()).dialog("open")};
...
FiercePlanet.showResourceGallery=function(){$("#current-profile-class")[0].innerHTML=FiercePlanet.currentProfile.profile_class;$("#current-credits")[0].innerHTML=FiercePlanet.currentProfile.credits;$("#current-capabilities")[0].innerHTML=FiercePlanet.currentProfile.capabilities.join(",");var a=[],b=[];if(FiercePlanet.profile_class=="Novice")a=FiercePlanet.NOVICE_CAPABILITIES;else if(FiercePlanet.profile_class=="Planner")a=FiercePlanet.PLANNER_CAPABILITIES;else if(FiercePlanet.profile_class=="Expert")a=
FiercePlanet.EXPERT_CAPABILITIES;else if(FiercePlanet.profile_class=="Visionary")a=FiercePlanet.VISIONARY_CAPABILITIES;else if(FiercePlanet.profile_class=="Genius")a=FiercePlanet.GENIUS_CAPABILITIES;for(var a=FiercePlanet.GENIUS_CAPABILITIES,c=$(".purchase"),d=0;d<c.length;d++){var e=c[d],f=e.id,f=f.split("-purchase")[0],g=0;$.inArray(f,FiercePlanet.PLANNER_CAPABILITIES)>-1?g=FiercePlanet.CAPABILITY_COSTS[1]:$.inArray(f,FiercePlanet.EXPERT_CAPABILITIES)>-1?g=FiercePlanet.CAPABILITY_COSTS[2]:$.inArray(f,
FiercePlanet.VISIONARY_CAPABILITIES)>-1?g=FiercePlanet.CAPABILITY_COSTS[3]:$.inArray(f,FiercePlanet.GENIUS_CAPABILITIES)>-1&&(g=FiercePlanet.CAPABILITY_COSTS[4]);$.inArray(f,a)>-1&&$.inArray(f,FiercePlanet.currentProfile.capabilities)==-1&&g<FiercePlanet.currentProfile.credits?b.push(e):$("#"+e.id).css("border","1px solid white")}for(d=0;d<b.length;d++)e=b[d],f=e.id,f=f.split("-purchase")[0],g=0,$.inArray(f,FiercePlanet.PLANNER_CAPABILITIES)?g=FiercePlanet.CAPABILITY_COSTS[1]:$.inArray(f,FiercePlanet.EXPERT_CAPABILITIES)?
g=FiercePlanet.CAPABILITY_COSTS[2]:$.inArray(f,FiercePlanet.VISIONARY_CAPABILITIES)?g=FiercePlanet.CAPABILITY_COSTS[3]:$.inArray(f,FiercePlanet.GENIUS_CAPABILITIES)&&(g=FiercePlanet.CAPABILITY_COSTS[4]),e.addEventListener("click",function(a){var b=this.id;console.log(b);var c=b.split("-purchase")[0],d=$("#"+b+"")[0].title;if($.inArray(c,FiercePlanet.currentProfile.capabilities)==-1&&confirm('Purchase item "'+d+'"?'))FiercePlanet.currentProfile.credits-=g,FiercePlanet.currentProfile.capabilities.push(c),
$("#current-credits")[0].innerHTML=FiercePlanet.currentProfile.credits,$("#current-capabilities")[0].innerHTML=FiercePlanet.currentProfile.capabilities.join(", "),$("#"+b).removeClass("active"),$("#"+b).addClass("inactive");a.stopPropagation();return!1},!0),$("#"+e.id).removeClass("inactive"),$("#"+e.id).addClass("active");FiercePlanet.$resourceGallery.dialog("open")};FiercePlanet.showSettings=function(){FiercePlanet.$settingsDialog.dialog("open")};
FiercePlanet.showCredits=function(){FiercePlanet._stopAgents();FiercePlanet.$genericDialog=$("<div></div>").html("<div class='credits'>Development Director</div><div>Liam Magee</div><div class='credits'>Art &amp; Design</div><div>Steven Harris</div><div class='credits'>Game Conception &amp; Testing</div><div>Joshua Magee</div><div>Jakki Mann</div>").dialog({position:[FiercePlanet.calculateWorldLeft(),110],width:487,height:407,autoOpen:!1,modal:!0,title:"Credits",buttons:{OK:function(){$(this).dialog("close")}}});
...
FiercePlanet.audio.loop=!0,FiercePlanet.audio.addEventListener("ended",function(){FiercePlanet.audio.currentTime=0;FiercePlanet.audio.play()},!1),FiercePlanet.audio.play()};FiercePlanet._stopAgents=function(){typeof console!="undefined"&&console.log("Pausing agents...");$("#playAgents").removeClass("playing");$("#playAgents").addClass("pausing");clearInterval(FiercePlanet.agentTimerId);FiercePlanet.inPlay=!1;FiercePlanet.soundsPlayable&&FiercePlanet.audio!=void 0&&FiercePlanet.audio.pause()};FiercePlanet=FiercePlanet||{};FiercePlanet.MOVE_HEALTH_COST=-2;FiercePlanet.SAVE_SCORE=10;FiercePlanet.STARTING_STORE=100;FiercePlanet.DEFAULT_RESOURCE_RECOVERY=2;FiercePlanet.WAVE_GOODNESS_BONUS=5;FiercePlanet.NEW_LEVEL_DELAY=3E3;FiercePlanet.NEW_WAVE_DELAY=200;FiercePlanet.EASY_DIFFICULTY=1;FiercePlanet.MEDIUM_DIFFICULTY=2;FiercePlanet.HARD_DIFFICULTY=3;FiercePlanet.EXTREME_DIFFICULTY=4;FiercePlanet.WORLD_WIDTH=480;FiercePlanet.WORLD_HEIGHT=400;FiercePlanet.WAVE_NOTICE_WIDTH=200;
FiercePlanet.WAVE_NOTICE_HEIGHT=150;FiercePlanet.currentProfile=new Profile;FiercePlanet.inDesignMode=!1;FiercePlanet.inPlay=!1;FiercePlanet.isMouseDown=!1;FiercePlanet.isMouseMoving=!1;FiercePlanet.scrollingImageVisible=!0;FiercePlanet.noticesVisible=!0;FiercePlanet.agentsCanCommunicate=!0;FiercePlanet.catastrophesVisible=!0;FiercePlanet.disableKeyboardShortcuts=!0;FiercePlanet.soundsPlayable=!1;FiercePlanet.recording=!1;FiercePlanet.invisiblePath=!1;FiercePlanet.agentTracing=!1;
FiercePlanet.resourcesUpgradeable=!1;FiercePlanet.resourcesInTension=!1;FiercePlanet.resourceBonus=!1;FiercePlanet.applyGeneralHealth=!1;FiercePlanet.ignoreResourceBalance=!1;FiercePlanet.godMode=!1;FiercePlanet.predatorsVisible=!1;FiercePlanet.rivalsVisible=!1;FiercePlanet.tilesMutable=!1;FiercePlanet.tilesRemovable=!1;FiercePlanet.backgroundIconsVisible=!1;FiercePlanet.resourceTypeNamespace=TBL;FiercePlanet.resourceCategories=[];FiercePlanet.resourceTypes=[];FiercePlanet.agentTimerId=0;
FiercePlanet.eventTarget=new EventTarget;FiercePlanet.recordedLevels=[];FiercePlanet.currentLevelNumber=1;FiercePlanet.currentWave=1;FiercePlanet.currentLevelPreset=!0;FiercePlanet.currentLevel=null;FiercePlanet.existingCurrentLevel=null;FiercePlanet.currentResourceId=null;FiercePlanet.currentResource=null;FiercePlanet.currentNotice=null;FiercePlanet.waveOverride=0;FiercePlanet.maxWaveMoves=0;FiercePlanet.maxLevelMoves=0;FiercePlanet.levelOfDifficulty=FiercePlanet.MEDIUM_DIFFICULTY;
FiercePlanet.resourceRecoveryCycle=5;FiercePlanet.interval=20;FiercePlanet.levelDelayCounter=0;FiercePlanet.waveDelayCounter=0;FiercePlanet.numAgents=1;FiercePlanet.waveCounter=0;FiercePlanet.levelCounter=0;FiercePlanet.gameCounter=0;FiercePlanet.globalRecordingCounter=0;FiercePlanet.zoomLevel=1;FiercePlanet.externalZoomLevel=1;FiercePlanet.panLeftOffset=0;FiercePlanet.panTopOffset=0;FiercePlanet.worldWidth=14;FiercePlanet.worldHeight=11;FiercePlanet.cellWidth=FiercePlanet.WORLD_WIDTH/FiercePlanet.worldWidth;
FiercePlanet.cellHeight=FiercePlanet.WORLD_HEIGHT/FiercePlanet.worldHeight;FiercePlanet.pieceWidth=FiercePlanet.cellWidth*0.5;FiercePlanet.pieceHeight=FiercePlanet.cellHeight*0.5;FiercePlanet.scrollingImage=new Image;FiercePlanet.scrollingImageX=0;FiercePlanet.scrollingImageOffset=1;FiercePlanet.audio=null;FiercePlanet.googleMap=null;FiercePlanet.currentX=null;FiercePlanet.currentY=null;FiercePlanet.$gameOver=null;FiercePlanet.$completeLevel=null;FiercePlanet.$completeGame=null;
FiercePlanet.$levelList=null;FiercePlanet.$upgradeDelete=null;FiercePlanet.$resourceGallery=null;FiercePlanet.$newLevel=null;FiercePlanet.$settingsDialog=null;FiercePlanet.$genericDialog=null;FiercePlanet.$highScores=null;FiercePlanet.$designFeatures=null;FiercePlanet.$editProperties=null;FiercePlanet=FiercePlanet||{};FiercePlanet.loadSettingsFromStorage=function(){FiercePlanet.currentLevelNumber=localStorage.currentLevelNumber!=void 0?parseInt(localStorage.currentLevelNumber):FiercePlanet.currentLevelNumber;FiercePlanet.currentLevelPreset=localStorage.currentLevelPreset!=void 0?localStorage.currentLevelPreset==="true":FiercePlanet.currentLevelPreset;FiercePlanet.current_score=localStorage.current_score!=void 0?parseInt(localStorage.current_score):FiercePlanet.current_score};
