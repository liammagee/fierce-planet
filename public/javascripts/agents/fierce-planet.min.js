...
Tile.prototype.setY=function(a){this._y=a};FiercePlanet.PROFILE_CLASSES=["Novice","Planner","Expert","Visionary","Genius"];FiercePlanet.CAPABILITY_COSTS=[0,100,200,300,500];
function Profile(){this.id=-1;this.profile_class=FiercePlanet.PROFILE_CLASSES[0];this.capabilities=FiercePlanet.NOVICE_CAPABILITIES;this.progress_towards_next_class=0;this.status="";this.total_saved=this.credits=0;this.total_resources=this.total_expired=1;this.resource_count=this.highest_score=this.current_score=this.previous_level_score=0;this.resources_in_store=FiercePlanet.STARTING_STORE;this.resources_spent=0;this.resourceStatsCount={};this.waves_survived=this.saved_agent_this_wave_count=this.saved_agent_count=
this.expired_agent_count=0;this.highest_level=this.current_level=1}Profile.prototype._initialise=function(){this.saved_agent_count=this.saved_agent_count||0;this.resources_in_store=this.resources_in_store||FiercePlanet.STARTING_STORE};
Profile.prototype.updateStats=function(a){this.credits+=this.resources_in_store;this.total_saved+=this.saved_agent_count;this.current_level=a||this.current_level;if(this.highest_score<this.current_score)this.highest_score=this.current_score;if(this.highest_level<this.current_level)this.highest_level=this.current_level;this.evaluateProfileClass()};
Profile.prototype.evaluateProfileClass=function(){this.total_saved>5E3?(this.profile_class=FiercePlanet.PROFILE_CLASSES[4],this.progress_towards_next_class=0):this.total_saved>2500?(this.profile_class=FiercePlanet.PROFILE_CLASSES[3],this.progress_towards_next_class=5E3-this.total_saved):this.total_saved>1E3?(this.profile_class=FiercePlanet.PROFILE_CLASSES[2],this.progress_towards_next_class=2500-this.total_saved):this.total_saved>500?(this.profile_class=FiercePlanet.PROFILE_CLASSES[1],this.progress_towards_next_class=
1E3-this.total_saved):this.progress_towards_next_class=500-this.total_saved};Profile.makeProfile=function(a){a.updateStats=Profile.prototype.updateStats;a.evaluateProfileClass=Profile.prototype.evaluateProfileClass;a._initialise=Profile.prototype._initialise;a._initialise()};function PlayerClass(a,b){this._name=a;this._savesRequired=b}PlayerClass.prototype.getName=function(){return this._name};PlayerClass.prototype.setName=function(a){this._name=a};PlayerClass.prototype.getSavesRequired=function(){return this._savesRequired};PlayerClass.prototype.setSavesRequired=function(a){this._savesRequired=a};function Settings(){this.disableKeyboardShortcuts=this.catastrophesVisible=this.agentsCanCommunicate=this.noticesVisible=this.scrollingImageVisible=!0;this.backgroundIconsVisible=this.tilesRemovable=this.tilesMutable=this.rivalsVisible=this.predatorsVisible=this.godMode=this.ignoreResourceBalance=this.applyGeneralHealth=this.resourceBonus=this.resourcesInTension=this.resourcesUpgradeable=this.agentTracing=this.invisiblePath=this.recording=this.soundsPlayable=!1};function Event(a,b,c,d,e,f){this.type=a;this._source=b;this._event=c;this._time=d;this._levelContext=e;this._data=f}function EventTarget(){this._listeners={}}
...
FiercePlanet.setupDialogs=function(){var a=FiercePlanet.calculateWorldLeft(),b=FiercePlanet.calculateWorldTop();FiercePlanet.$newLevel=$("<div></div>").html("New Level").dialog({position:[a,b],width:487,height:407,autoOpen:!1,modal:!0,title:"New Level",buttons:{Play:function(){$(this).dialog("close");var a=$("#map_canvas, #baseCanvas"),b=$("#world"),e=b.position().left,f=b.position().top,g=b.width(),h=b.height();b.css({width:0,height:0,left:e+Math.floor(Math.random()*g),top:f+Math.floor(Math.random()*
h)});b.animate({width:g,height:h,left:e,top:f},1E3);a.css({width:0,height:0});a.animate({width:g,height:h},1E3);FiercePlanet.newWave()},Cancel:function(){$(this).dialog("close")}}});FiercePlanet.$completeLevel=$("<div></div>").html("Level Complete!").dialog({position:[a,b],width:487,height:407,autoOpen:!1,modal:!0,title:"Level Complete!",buttons:{"Next Level":function(){FiercePlanet.newLevel();$(this).dialog("close")},Cancel:function(){FiercePlanet.newLevel();$(this).dialog("close")}}});FiercePlanet.$completeGame=
$("<div></div>").html("Complete game!").dialog({position:[a,b],width:487,height:407,autoOpen:!1,modal:!0,title:"Fierce Planet Complete!",buttons:{"New Game":function(){FiercePlanet.newGame();$(this).dialog("close")},Cancel:function(){$(this).dialog("close")}}});FiercePlanet.$gameOver=$("<div></div>").html("Game Over!").dialog({position:[a,b],width:487,height:407,autoOpen:!1,modal:!0,title:"Game Over!",buttons:{"Restart Level":function(){FiercePlanet.restartLevel();$(this).dialog("close")},"New Game":function(){FiercePlanet.newGame();
$(this).dialog("close")}}});FiercePlanet.$upgradeDelete=$("#delete-upgrade-dialog").dialog({position:[a,b],width:487,height:407,autoOpen:!1,modal:!0,title:"Upgrade or Delete Resource",buttons:{Cancel:function(){$(this).dialog("close")}}});$("#del-button").click(function(){FiercePlanet.deleteCurrentResource();FiercePlanet.$upgradeDelete.dialog("close")});$("#upg-button").click(function(){FiercePlanet.upgradeCurrentResource();FiercePlanet.$upgradeDelete.dialog("close")});FiercePlanet.$resourceGallery=
$("#resource-gallery").dialog({position:[a,b],width:487,height:407,autoOpen:!1,modal:!0,title:"Resource Gallery",buttons:{"Save Capabilities":function(){FiercePlanet.refreshSwatch();FiercePlanet.saveCapabilities();$(this).dialog("close")},Cancel:function(){$(this).dialog("close")}}});FiercePlanet.$settingsDialog=$("#settings-dialog").dialog({position:[a,b],width:487,height:407,autoOpen:!1,modal:!0,title:"Settings",buttons:{"Save Settings":function(){FiercePlanet.setAndStoreProperties();$(this).dialog("close")},
Cancel:function(){$(this).dialog("close")}}});$("#tutorial").click(function(){if(confirm("Stop current game and begin the tutorial?"))FiercePlanet.currentLevelNumber=0,FiercePlanet.currentLevelPreset=!0,FiercePlanet.restartLevel()});FiercePlanet.$statsDialog=$("<div></div>").dialog({position:[a,110],width:487,height:407,autoOpen:!1,modal:!0,title:"Vital Statistics",buttons:{OK:function(){$(this).dialog("close")}}});FiercePlanet.$designFeatures=$("#level-features").dialog({position:[a,110],width:487,
height:407,autoOpen:!1,modal:!0,title:"Add design features",buttons:{Cancel:function(){$(this).dialog("close")}}});FiercePlanet.$editProperties=$("<div></div>").html("Edit level properties").dialog({position:[a,110],width:487,height:407,autoOpen:!1,modal:!0,title:"Edit level properties",buttons:{"Save Level":function(){$(".edit_level_properties").submit();FiercePlanet.drawGame();$(this).dialog("close")},Cancel:function(){$(this).dialog("close")}}})};
FiercePlanet.showGameOverDialog=function(){FiercePlanet.currentProfile.id>-1?FiercePlanet.updateStats(function(){FiercePlanet.openGameOverDialog()}):FiercePlanet.openGameOverDialog()};FiercePlanet.openGameOverDialog=function(){FiercePlanet.$gameOver.html("Unfortunately Fierce Planet has gotten the better of its citizens! Click 'Restart Level' or 'New Game' to try again."+FiercePlanet.generateStats()).dialog("open")};
FiercePlanet.showCompleteGameDialog=function(){FiercePlanet.currentProfile.updateStats(FiercePlanet.currentProfile.resources_in_store,FiercePlanet.currentProfile.saved_agent_count,FiercePlanet.currentLevelNumber);FiercePlanet.currentProfile.id>-1?FiercePlanet.updateStats(function(){FiercePlanet.openCompleteGameDialog()}):FiercePlanet.openCompleteGameDialog()};
...
FiercePlanet.showCompleteLevelDialog=function(){FiercePlanet.currentProfile.updateStats(FiercePlanet.currentLevelNumber);FiercePlanet.currentProfile.id>-1?FiercePlanet.updateStats(function(){FiercePlanet.openCompleteLevelDialog()}):FiercePlanet.openCompleteLevelDialog()};FiercePlanet.openCompleteLevelDialog=function(){FiercePlanet.$completeLevel.html("<div>"+FiercePlanet.currentLevel.getConclusion()+"</div>"+FiercePlanet.generateStats()).dialog("open")};
...
c,b)),FiercePlanet.drawGame()):FiercePlanet.currentResourceId!=null?FiercePlanet.dropItem(a):(b=FiercePlanet.getCurrentPosition(a),FiercePlanet.currentLevel.removeTile(b.posX,b.posY),FiercePlanet.drawGame()):FiercePlanet.currentResourceId!=null&&FiercePlanet.dropItem(a)};
FiercePlanet.showResourceGallery=function(){FiercePlanet.pauseGame();$("#current-profile-class")[0].innerHTML=FiercePlanet.currentProfile.profile_class;$("#current-credits")[0].innerHTML=FiercePlanet.currentProfile.credits;$("#current-capabilities")[0].innerHTML=FiercePlanet.currentProfile.capabilities.join(",");var a=[],b=[];if(FiercePlanet.profile_class=="Novice")a=FiercePlanet.NOVICE_CAPABILITIES;else if(FiercePlanet.profile_class=="Planner")a=FiercePlanet.PLANNER_CAPABILITIES;else if(FiercePlanet.profile_class==
"Expert")a=FiercePlanet.EXPERT_CAPABILITIES;else if(FiercePlanet.profile_class=="Visionary")a=FiercePlanet.VISIONARY_CAPABILITIES;else if(FiercePlanet.profile_class=="Genius")a=FiercePlanet.GENIUS_CAPABILITIES;for(var a=FiercePlanet.GENIUS_CAPABILITIES,c=$(".purchase"),d=0;d<c.length;d++){var e=c[d],f=e.id,f=f.split("-purchase")[0],g=0;$.inArray(f,FiercePlanet.PLANNER_CAPABILITIES)>-1?g=FiercePlanet.CAPABILITY_COSTS[1]:$.inArray(f,FiercePlanet.EXPERT_CAPABILITIES)>-1?g=FiercePlanet.CAPABILITY_COSTS[2]:
$.inArray(f,FiercePlanet.VISIONARY_CAPABILITIES)>-1?g=FiercePlanet.CAPABILITY_COSTS[3]:$.inArray(f,FiercePlanet.GENIUS_CAPABILITIES)>-1&&(g=FiercePlanet.CAPABILITY_COSTS[4]);$.inArray(f,a)>-1&&$.inArray(f,FiercePlanet.currentProfile.capabilities)==-1&&g<FiercePlanet.currentProfile.credits?b.push(e):$("#"+e.id).css("border","1px solid white")}for(d=0;d<b.length;d++)e=b[d],f=e.id,f=f.split("-purchase")[0],g=0,$.inArray(f,FiercePlanet.PLANNER_CAPABILITIES)?g=FiercePlanet.CAPABILITY_COSTS[1]:$.inArray(f,
FiercePlanet.EXPERT_CAPABILITIES)?g=FiercePlanet.CAPABILITY_COSTS[2]:$.inArray(f,FiercePlanet.VISIONARY_CAPABILITIES)?g=FiercePlanet.CAPABILITY_COSTS[3]:$.inArray(f,FiercePlanet.GENIUS_CAPABILITIES)&&(g=FiercePlanet.CAPABILITY_COSTS[4]),e.addEventListener("click",function(a){var b=this.id;console.log(b);var c=b.split("-purchase")[0],d=$("#"+b+"")[0].title;if($.inArray(c,FiercePlanet.currentProfile.capabilities)==-1&&confirm('Purchase item "'+d+'"?'))FiercePlanet.currentProfile.credits-=g,FiercePlanet.currentProfile.capabilities.push(c),
$("#current-credits")[0].innerHTML=FiercePlanet.currentProfile.credits,$("#current-capabilities")[0].innerHTML=FiercePlanet.currentProfile.capabilities.join(", "),$("#"+b).removeClass("active"),$("#"+b).addClass("inactive");a.stopPropagation();return!1},!0),$("#"+e.id).removeClass("inactive"),$("#"+e.id).addClass("active");FiercePlanet.$resourceGallery.dialog("open")};FiercePlanet.showSettings=function(){FiercePlanet.pauseGame();FiercePlanet.$settingsDialog.dialog("open")};
...
FiercePlanet.getCurrentPosition=function(a){var b,c;if(a.offsetX||a.offsetX==0)b=a.offsetX,c=a.offsetY;else if(a.layerX||a.layerX==0)b=a.layerX,c=a.layerY;b-=FiercePlanet.panLeftOffset;c-=FiercePlanet.panTopOffset;b/=FiercePlanet.zoomLevel;c/=FiercePlanet.zoomLevel;b-=1/FiercePlanet.zoomLevel;c-=1/FiercePlanet.zoomLevel;return{posX:Math.floor(b/FiercePlanet.cellWidth),posY:Math.floor(c/FiercePlanet.cellHeight)}};FiercePlanet.notify=function(a){$("#notifications")[0].innerHTML=a};
...
FiercePlanet.storeData=function(){localStorage.current_score=FiercePlanet.previous_level_score;localStorage.currentLevelNumber=FiercePlanet.currentLevelNumber;localStorage.currentLevelPreset=FiercePlanet.currentLevel.isPresetLevel();localStorage.currentProfile=$.toJSON(FiercePlanet.currentProfile)};FiercePlanet.serializeProfile=function(){FiercePlanet.currentLevel.getResources();var a={},a=FiercePlanet.currentProfile;return{profile_object:$.toJSON(a)}};
FiercePlanet.generateStats=function(){return"<table><tr><td>Level:</td><td>"+FiercePlanet.currentLevel.getId()+"</td></tr><tr><td>Waves survived:</td><td>"+FiercePlanet.currentWave+"</td></tr><tr><td>Score:</td><td>"+FiercePlanet.currentProfile.current_score+"</td></tr><tr><td>Citizens saved:</td><td>"+FiercePlanet.currentProfile.saved_agent_count+"</td></tr><tr><td>Citizens expired:</td><td>"+FiercePlanet.currentProfile.expired_agent_count+"</td></tr><tr><td>Resources spent:</td><td>"+FiercePlanet.currentProfile.resources_spent+
"</td></tr><tr><td>Resources remaining:</td><td>"+FiercePlanet.currentProfile.resources_in_store+"</td></tr><tr><td></td><td></td></tr><tr><td>Total saved:</td><td>"+FiercePlanet.currentProfile.total_saved+"</td></tr><tr><td>Profile class:</td><td>"+FiercePlanet.currentProfile.profile_class+"</td></tr><tr><td>Credits:</td><td><span style='font-weight:bold'>"+FiercePlanet.currentProfile.credits+" [<a href='#' id='gotoResourceGallery'>SPEND</a>]</span></td></tr></table>"};
FiercePlanet.updateStats=function(a){FiercePlanet.currentProfile.id>-1&&$.post("/profiles/"+FiercePlanet.currentProfile.id+"/update_stats",FiercePlanet.serializeProfile(),a)};FiercePlanet.saveCapabilities=function(){FiercePlanet.updateStats()};FiercePlanet=FiercePlanet||{};
...
'"></div>';$("#gallery-items").append(d);var d=$("#gallery-"+b.getCode()),e='<div class="title">'+b.getName()+"</div>";d.append(e);for(var f=e=0;f<b._types.length;f++){var g=b._types[f],h='<div class="swatch-instance" id="'+g.getCode()+'" title="'+g.getName()+'"><img src="'+g.getImage()+'" alt=""></div>';c.append(h);h=$("#"+g.getCode());e>0&&h.addClass("inactive");g='<div class="swatch-instance purchase inactive" id="'+g.getCode()+'-purchase" title="'+g.getName()+'"><img src="'+g.getImage()+'" alt=""></div>';
d.append(g);e++}}};FiercePlanet=FiercePlanet||{};
...
e.getSpeed(),e.getType()==AgentTypes.CITIZEN_AGENT_TYPE&&b++,FiercePlanet.waveCounter>=e.getDelay()){e.getDelay();g=e.getCountdownToMove()%f;if(g==0){e.getType()==AgentTypes.CITIZEN_AGENT_TYPE&&FiercePlanet.currentLevel.isExitPoint(e.getX(),e.getY())&&(FiercePlanet.currentProfile.current_score+=FiercePlanet.SAVE_SCORE,FiercePlanet.currentProfile.saved_agent_count++,FiercePlanet.currentProfile.saved_agent_this_wave_count++,a.push(d),FiercePlanet.currentProfile.resources_in_store+=FiercePlanet.currentWave<
5?4:FiercePlanet.currentWave<10?3:FiercePlanet.currentWave<20?2:1,FiercePlanet.drawScore(),FiercePlanet.drawResourcesInStore(),FiercePlanet.drawSaved());e.evaluateMove(FiercePlanet.currentLevel,h);e.getType()==AgentTypes.CITIZEN_AGENT_TYPE&&(e.resetCountdownToMove(),e.adjustSpeed(),e.adjustWander());if(e.getMoves()>FiercePlanet.maxWaveMoves)FiercePlanet.maxWaveMoves=e.getMoves();if(e.getType()==AgentTypes.CITIZEN_AGENT_TYPE||e.getType()==AgentTypes.RIVAL_AGENT_TYPE)FiercePlanet.currentSettings.godMode||
e.adjustHealth(FiercePlanet.MOVE_HEALTH_COST),e.getHealth()<=0?(a.push(d),e.getType()==AgentTypes.CITIZEN_AGENT_TYPE&&FiercePlanet.currentProfile.expired_agent_count++,FiercePlanet.drawExpired()):(FiercePlanet.processNeighbouringResources(e),FiercePlanet.processNeighbouringAgents(e))}e.getType()==AgentTypes.CITIZEN_AGENT_TYPE&&e.incrementCountdownToMove()}if(FiercePlanet.currentProfile.expired_agent_count>=FiercePlanet.currentLevel.getExpiryLimit())return FiercePlanet.gameOver();for(d=a.length-1;d>=
0;d-=1)FiercePlanet.currentLevel.getCurrentAgents().splice(a[d],1);if(b==0)if(FiercePlanet.currentWave<FiercePlanet.currentLevel.getWaveNumber())FiercePlanet.completeWave(),FiercePlanet.newWave();else if(FiercePlanet.currentLevelNumber<PresetLevels.MAX_DEFAULT_LEVELS)FiercePlanet.completeLevel(),FiercePlanet.levelDelayCounter=0;else return FiercePlanet.completeGame();else FiercePlanet.waveCounter%FiercePlanet.resourceRecoveryCycle==0&&FiercePlanet.recoverResources(),FiercePlanet.drawAgents();FiercePlanet.currentSettings.recording&&
FiercePlanet.recordWorld()}};FiercePlanet.processNeighbouringResources=function(a){for(var b=a.getX(),c=a.getY(),d=0;d<FiercePlanet.currentLevel.getResources().length;d++){var e=FiercePlanet.currentLevel.getResources()[d],f=e.getX(),g=e.getY();Math.abs(f-b)<=1&&Math.abs(g-c)<=1&&(f=FiercePlanet.calculateResourceEffect(e),e.provideYield(a,f),FiercePlanet.drawResource(e))}};
...
FiercePlanet.newGame=function(){if(FiercePlanet.currentLevelPreset)FiercePlanet.currentLevelNumber=1;FiercePlanet.current_score=0;FiercePlanet.previous_level_score=0;FiercePlanet.gameCounter=0;FiercePlanet.newLevel()};
FiercePlanet.newLevel=function(){FiercePlanet.inDesignMode=!1;FiercePlanet.levelDelayCounter=0;FiercePlanet.levelCounter=0;FiercePlanet.maxLevelMoves=0;FiercePlanet.previous_level_score=FiercePlanet.current_score;FiercePlanet.currentLevel!=void 0&&FiercePlanet.currentLevel.setResources([]);FiercePlanet.currentNotice=null;if(FiercePlanet.audio!=void 0)FiercePlanet.audio.pause(),FiercePlanet.audio=void 0;FiercePlanet.recordedLevels=[];FiercePlanet._initialiseGame();FiercePlanet.levelInfo();FiercePlanet.currentNotice=
FiercePlanet.currentLevel.getTip();FiercePlanet.notify("Starting level "+FiercePlanet.currentLevel.getId()+"...")};FiercePlanet.restartLevel=function(){FiercePlanet.current_score=FiercePlanet.previous_level_score;FiercePlanet.newLevel()};
FiercePlanet.newWave=function(){FiercePlanet.maxWaveMoves=0;FiercePlanet.waveCounter=0;FiercePlanet.waveDelayCounter=0;FiercePlanet.saved_agent_this_wave_count=0;FiercePlanet.currentLevel.presetAgents(AgentTypes.CITIZEN_AGENT_TYPE,FiercePlanet.numAgents,FiercePlanet.currentSettings.agentsCanCommunicate);FiercePlanet.notify("New wave coming...");FiercePlanet.drawEntryPoints();FiercePlanet.drawExitPoints();FiercePlanet.eventTarget.fire(new Event("game",this,"newWave",$fp.levelCounter,FiercePlanet.currentLevel));
FiercePlanet._startAgents()};FiercePlanet.completeWave=function(){FiercePlanet.currentWave++;FiercePlanet.numAgents++;FiercePlanet._finaliseGame()};FiercePlanet.completeLevel=function(){FiercePlanet.currentLevel.isPresetLevel()&&FiercePlanet.currentLevelNumber++;FiercePlanet._finaliseGame();FiercePlanet.showCompleteLevelDialog()};FiercePlanet.gameOver=function(){FiercePlanet.current_score=FiercePlanet.previous_level_score;FiercePlanet._finaliseGame();FiercePlanet.showGameOverDialog()};
...
eval("PresetLevels.level1");if(FiercePlanet.waveOverride>0)FiercePlanet.currentLevel.setWaveNumber(FiercePlanet.waveOverride),FiercePlanet.waveOverride=0;FiercePlanet.currentProfile.resources_in_store=FiercePlanet.currentLevel.getInitialResourceStore();if(FiercePlanet.currentProfile.resources_in_store==void 0||FiercePlanet.currentProfile.resources_in_store==null)FiercePlanet.currentProfile.resources_in_store=FiercePlanet.STARTING_STORE;FiercePlanet.currentLevel.setCurrentAgents([]);FiercePlanet.currentLevel.setResources([]);
if(FiercePlanet.currentLevel.getCatastrophe()!=void 0)FiercePlanet.currentLevel.getCatastrophe()._struck=!1;FiercePlanet.resourceStatsCount={};for(var b=0;b<FiercePlanet.resourceCategories.length;b++)FiercePlanet.resourceStatsCount[FiercePlanet.resourceCategories[b].getCode()]=0;FiercePlanet.currentProfile.expired_agent_count=0;FiercePlanet.currentProfile.saved_agent_count=0;FiercePlanet.currentWave=1;FiercePlanet.resourceRecoveryCycle=Math.pow(FiercePlanet.DEFAULT_RESOURCE_RECOVERY,FiercePlanet.levelOfDifficulty-
1);FiercePlanet.numAgents=FiercePlanet.currentLevel.getInitialAgentNumber();FiercePlanet.worldWidth=FiercePlanet.currentLevel.getWorldWidth();FiercePlanet.worldHeight=FiercePlanet.currentLevel.getWorldHeight();FiercePlanet.cellWidth=FiercePlanet.WORLD_WIDTH/FiercePlanet.worldWidth;FiercePlanet.cellHeight=FiercePlanet.WORLD_HEIGHT/FiercePlanet.worldHeight;FiercePlanet.pieceWidth=FiercePlanet.cellWidth*0.5;FiercePlanet.pieceHeight=FiercePlanet.cellHeight*0.5;FiercePlanet.scrollingImage.src="/images/yellow-rain.png";
FiercePlanet.currentLevel.setup();FiercePlanet.drawGame()};FiercePlanet._finaliseGame=function(){FiercePlanet._stopAgents();FiercePlanet.storeData();FiercePlanet.drawScoreboard()};
