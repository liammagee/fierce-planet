...
Profile.prototype.updateStats=function(){this.current_level=currentLevelNumber||this.current_level;this.game_total_saved+=this.current_level_saved;this.game_total_expired+=this.current_level_expired;if(this.game_level<this.current_level)this.game_level=this.current_level;if(this.game_score<this.current_score)this.game_score=this.current_score;this.credits+=this.current_level_resources_in_store;this.total_saved+=this.current_level_saved;this.total_expired+=this.current_level_expired;if(this.highest_score<
this.current_score)this.highest_score=this.current_score;if(this.highest_level<this.current_level)this.highest_level=this.current_level;this.evaluateProfileClass()};
...
m||"500 14px/2 Unknown Font, sans-serif"};FiercePlanet.FARM_RESOURCE_TYPE=new ResourceType("Farm","farm","/images/resources/farm.png",10,20,100,20);FiercePlanet.SHOP_RESOURCE_TYPE=new ResourceType("Shop","shop","/images/resources/shop.png",15,25,100,30);FiercePlanet.BANK_RESOURCE_TYPE=new ResourceType("Bank","bank","/images/resources/bank.png",20,30,100,50);FiercePlanet.FACTORY_RESOURCE_TYPE=new ResourceType("Factory","factory","/images/resources/factory.png",25,40,100,70);
FiercePlanet.STOCKMARKET_RESOURCE_TYPE=new ResourceType("Stockmarket","stockmarket","/images/resources/stockmarket.png",30,50,100,90);FiercePlanet.FRESH_WATER_RESOURCE_TYPE=new ResourceType("Fresh Water","water","/images/resources/water.png",10,20,100,10);FiercePlanet.WILDLIFE_PARK_RESOURCE_TYPE=new ResourceType("Wildlife Park","park","/images/resources/park.png",15,25,100,15);FiercePlanet.CLEAN_AIR_RESOURCE_TYPE=new ResourceType("Clear Air","air","/images/resources/air.png",20,30,100,25);
FiercePlanet.GREEN_ENERGY_RESOURCE_TYPE=new ResourceType("Green Energy","energy","/images/resources/energy.png",25,40,100,35);FiercePlanet.BIODIVERSITY_RESOURCE_TYPE=new ResourceType("Biodiversity","biodiversity","/images/resources/biodiversity.png",30,50,100,45);FiercePlanet.CLINIC_RESOURCE_TYPE=new ResourceType("Clinic","clinic","/images/resources/clinic.png",10,20,100,5);FiercePlanet.SCHOOL_RESOURCE_TYPE=new ResourceType("School","school","/images/resources/school.png",15,25,100,8);
FiercePlanet.LEGAL_SYSTEM_RESOURCE_TYPE=new ResourceType("Legal System","legal","/images/resources/legal.png",20,30,100,15);FiercePlanet.DEMOCRACY_RESOURCE_TYPE=new ResourceType("Democracy","democracy","/images/resources/democracy.png",25,40,100,20);FiercePlanet.FESTIVAL_RESOURCE_TYPE=new ResourceType("Festival","festival","/images/resources/festival.png",30,50,100,25);FiercePlanet.NOVICE_CAPABILITIES=["farm","water","clinic"];
...
Cancel:function(){FiercePlanet.newLevel();$(this).dialog("close")}}});FiercePlanet.$completeGame=$("<div></div>").html("Complete game!").dialog({position:[a,b],width:FiercePlanet.WORLD_WIDTH+7,height:FiercePlanet.WORLD_HEIGHT+7,autoOpen:!1,modal:!0,title:"Fierce Planet Complete!",buttons:{"New Game":function(){FiercePlanet.newGame();$(this).dialog("close")},Cancel:function(){$(this).dialog("close")}}});FiercePlanet.$gameOver=$("<div></div>").html("Game Over!").dialog({position:[a,b],width:FiercePlanet.WORLD_WIDTH+
7,height:FiercePlanet.WORLD_HEIGHT+7,autoOpen:!1,modal:!0,title:"Game Over!",buttons:{"Restart Level":function(){FiercePlanet.restartLevel();$(this).dialog("close")},"New Game":function(){FiercePlanet.newGame();$(this).dialog("close")}}});FiercePlanet.$upgradeDelete=$("#delete-upgrade-dialog").dialog({position:[a,b],width:FiercePlanet.WORLD_WIDTH+7,height:FiercePlanet.WORLD_HEIGHT+7,autoOpen:!1,modal:!0,title:"Upgrade or Delete Resource",buttons:{Cancel:function(){$(this).dialog("close")}}});$("#del-button").click(function(){FiercePlanet.deleteCurrentResource();
FiercePlanet.$upgradeDelete.dialog("close")});$("#upg-button").click(function(){FiercePlanet.upgradeCurrentResource();FiercePlanet.$upgradeDelete.dialog("close")});FiercePlanet.$resourceGallery=$("#resource-gallery").dialog({position:[a,b],width:FiercePlanet.WORLD_WIDTH+7,height:FiercePlanet.WORLD_HEIGHT+7,autoOpen:!1,modal:!0,title:"Resource Gallery",buttons:{"Save Capabilities":function(){FiercePlanet.refreshSwatch();FiercePlanet.saveCapabilities();$(this).dialog("close")},Cancel:function(){$(this).dialog("close")}}});
FiercePlanet.$settingsDialog=$("#settings-dialog").dialog({position:[a,b],width:487,height:407,autoOpen:!1,modal:!0,title:"Settings",buttons:{"Save Settings":function(){FiercePlanet.setAndStoreProperties();$(this).dialog("close")},Cancel:function(){$(this).dialog("close")}}});$("#tutorial").click(function(){if(confirm("Stop current game and begin the tutorial?"))FiercePlanet.currentLevelNumber=0,FiercePlanet.currentLevelPreset=!0,FiercePlanet.restartLevel()});FiercePlanet.$statsDialog=$("<div></div>").dialog({position:[a,
110],width:FiercePlanet.WORLD_WIDTH+7,height:FiercePlanet.WORLD_HEIGHT+7,autoOpen:!1,modal:!0,title:"Vital Statistics",buttons:{OK:function(){$(this).dialog("close")}}});FiercePlanet.$designFeatures=$("#level-features").dialog({position:[a,110],width:FiercePlanet.WORLD_WIDTH+7,height:FiercePlanet.WORLD_HEIGHT+7,autoOpen:!1,modal:!0,title:"Add design features",buttons:{Cancel:function(){$(this).dialog("close")}}});FiercePlanet.$editProperties=$("<div></div>").html("Edit level properties").dialog({position:[a,
110],width:FiercePlanet.WORLD_WIDTH+7,height:FiercePlanet.WORLD_HEIGHT+7,autoOpen:!1,modal:!0,title:"Edit level properties",buttons:{"Save Level":function(){$(".edit_level_properties").submit();FiercePlanet.drawGame();$(this).dialog("close")},Cancel:function(){$(this).dialog("close")}}})};FiercePlanet.showGameOverDialog=function(){FiercePlanet.currentProfile.id>-1?FiercePlanet.saveProfile(function(){FiercePlanet.openGameOverDialog()}):FiercePlanet.openGameOverDialog()};
FiercePlanet.openGameOverDialog=function(){FiercePlanet.$gameOver.html("Unfortunately Fierce Planet has gotten the better of its citizens! Click 'Restart Level' or 'New Game' to try again."+FiercePlanet.generateStats()).dialog("open")};FiercePlanet.showCompleteGameDialog=function(){FiercePlanet.currentProfile.id>-1?FiercePlanet.updateStats(function(){FiercePlanet.openCompleteGameDialog()}):FiercePlanet.openCompleteGameDialog()};
FiercePlanet.openCompleteGameDialog=function(){FiercePlanet.$completeGame.html("Congratulations! In spite of challenges ahead, the citizens of Fierce Planet look forward to a bright and sustainable future!"+FiercePlanet.generateStats()).dialog("open");$("#gotoResourceGallery").click(FiercePlanet.showResourceGallery)};FiercePlanet.showCompleteLevelDialog=function(){FiercePlanet.currentProfile.id>-1?FiercePlanet.saveProfile(function(){FiercePlanet.openCompleteLevelDialog()}):FiercePlanet.openCompleteLevelDialog()};
FiercePlanet.openCompleteLevelDialog=function(){FiercePlanet.$completeLevel.html("<div>"+FiercePlanet.currentLevel.getConclusion()+"</div>"+FiercePlanet.generateStats()).dialog("open")};
...
b._start+b._duration>=FiercePlanet.levelCounter){FiercePlanet.levelCounter>=(b._start+b._duration)/2&&b.strike();var c=b._duration/FiercePlanet.WORLD_WIDTH,d=FiercePlanet.WORLD_WIDTH-(FiercePlanet.levelCounter-b._start)/c*2,b=(b._start+b._duration-FiercePlanet.levelCounter)/c*2,c=FiercePlanet.WORLD_HEIGHT;a.fillStyle="rgba(128, 128, 255, 0.5)";a.fillRect(d,0,b,c);return}}FiercePlanet.scrollingImageX+FiercePlanet.scrollingImageOffset<480-FiercePlanet.scrollingImageOffset?FiercePlanet.scrollingImageX+=
FiercePlanet.scrollingImageOffset:FiercePlanet.scrollingImageX=1;try{a.drawImage(FiercePlanet.scrollingImage,FiercePlanet.scrollingImageX,1,480,400,0,0,480,400)}catch(e){}}};FiercePlanet.drawLevel=function(){$("#level-display")[0].innerHTML=FiercePlanet.currentLevel.getId()};FiercePlanet.drawProfileClass=function(){var a=$("#profile-class-display")[0];if(a!=void 0)a.innerHTML=FiercePlanet.currentProfile.profile_class};
...
FiercePlanet.drawExpired=function(){for(var a=$("#expired-citizens")[0],b="",c=0,d=FiercePlanet.currentLevel.getExpiryLimit();c<d;c++)b+=c<FiercePlanet.currentProfile.current_level_expired?'<div id="expired-citizen"></div>':'<div id="healthy-citizen"></div>';a.innerHTML=b};FiercePlanet.drawSaved=function(){$("#saved-display")[0].innerHTML=FiercePlanet.currentProfile.current_level_saved.toString()};
...
"</td></tr><tr><td>Resources remaining:</td><td>"+FiercePlanet.currentProfile.current_level_resources_in_store+"</td></tr><tr><td></td><td></td></tr><tr><td>Total saved:</td><td>"+FiercePlanet.currentProfile.game_total_saved+"</td></tr><tr><td>Profile class:</td><td>"+FiercePlanet.currentProfile.profile_class+"</td></tr><tr><td>Credits:</td><td><span style='font-weight:bold'>"+FiercePlanet.currentProfile.credits+" [<a href='#' id='gotoResourceGallery'>$$$</a>]</span></td></tr></table>"};
FiercePlanet.saveProfile=function(a){FiercePlanet.currentProfile.id>-1&&$.post("/profiles/"+FiercePlanet.currentProfile.id+"/update_stats",FiercePlanet.serializeProfile(),a)};FiercePlanet.saveCapabilities=function(){FiercePlanet.saveProfile()};FiercePlanet=FiercePlanet||{};
...
PresetLevels.level3.setSoundSrc("http://db.tt/7KPJ8Xi");PresetLevels.level3.setCatastrophe(new Catastrophe(FiercePlanet.resourceCategories[1],1E3+Math.random()*2E3,250,0,new Notice("A tsumani will soon hit the city - all resources will be depleted.",void 0,void 0,500,250)));
